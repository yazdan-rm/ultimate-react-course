...
export default function App() {
  ...
  // How update data ??? below is solution
...
function FormAddFriend({onAddFriend}) {
  ...
  const [image, setImage] = useState('https://avatars.githubusercontent.com/u/116789371?s=400&u=21e1e81e2bdb8db47f043ad7c5232dfe7f91b957&v=4');
  ...
  function handleSubmit(e) {
    ...
    const newFriend = {
      name, image, balance: 0, id: crypto.randomUUID()
    }
    onAddFriend(newFriend);
    setName('');
    setImage('https://avatars.githubusercontent.com/u/116789371?s=400&u=21e1e81e2bdb8db47f043ad7c5232dfe7f91b957&v=4');
  };
