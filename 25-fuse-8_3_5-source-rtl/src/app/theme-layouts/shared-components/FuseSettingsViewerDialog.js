...
function FuseSettingsViewerDialog(props) {
  ...
  return (
    <div className={clsx('', className)}>
      ...
      >
     تنظیمات را به عنوان پارامترهای json/query مشاهده کنید
      </Button>

      <Dialog open={openDialog} onClose={handleCloseDialog} aria-labelledby="form-dialog-title">
        <DialogTitle className="">نمایشگر تنظیمات فیوز</DialogTitle>
        <DialogContent className="">
          ...
          <Typography className="text-16 font-bold mt-24 mb-16">پارامتر های کوئری</Typography>
