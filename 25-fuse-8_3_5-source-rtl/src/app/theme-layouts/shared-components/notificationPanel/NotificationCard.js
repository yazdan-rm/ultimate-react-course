    ...
    >
      {item.icon && !item.image && (
        <Box
          ...
          className="flex shrink-0 items-center justify-center w-32 h-32 ltr:ml-12 ltr:mr-0 rtl:mr-12 rtl:ml-0 rounded-full"
        >
      ...
      {item.image && (
        <img
          className="shrink-0 w-32 h-32 ltr:ml-12 ltr:mr-0 rtl:mr-12 rtl:ml-0 rounded-full overflow-hidden object-cover object-center"
          src={item.image}
          alt="Notification"
        />
      )}
      ...
      <IconButton
        disableRipple
        className="top-0 rtl:right-0 rtl:left-auto left:left-0 left:right-auto absolute p-8"
        color="inherit"
        size="small"
        onClick={handleClose}
      >
