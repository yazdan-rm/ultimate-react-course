...
function NotificationPanel(props) {
  ...
  return (
    <StyledSwipeableDrawer
      ...
      disableSwipeToOpen
    >
      <IconButton className="m-4 absolute top-0 rtl:right-0 rtl:left-auto left:left-0 left:right-auto z-999" onClick={handleClose} size="large">
        ...
        <FuseScrollbars className="p-16">
          <div className="flex flex-col">
            <div className="flex justify-between items-end pt-136 mb-36">
              <Typography className="text-28 font-semibold leading-none">اطلاعیه</Typography>
              <Typography
