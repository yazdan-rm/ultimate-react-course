    ...
    <Root
      ...
      content={
        <div className="flex-auto p-24 sm:p-40">
          <Typography className="text-20 font-700 mb-16">کاربرد</Typography>
          ...
          <Typography className="text-20 font-700 mt-32 mb-16">آیکون ها</Typography>
            ...
            <Controller
              ...
              render={({ field }) => (
                <FormControl sx={{ mt: 2, minWidth: 120 }}>
                  <InputLabel htmlFor="max-width">اندازه</InputLabel>
