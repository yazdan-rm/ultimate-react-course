...
export default function BarTreeView() {
  return (
    ...
    >
      <CustomTreeItem nodeId="1" label="اپلیکیشن ها">
        <CustomTreeItem nodeId="2" label="تقویم" />
        <CustomTreeItem nodeId="3" label="کروم" />
        <CustomTreeItem nodeId="4" label="وب استورم" />
      </CustomTreeItem>
      <CustomTreeItem nodeId="5" label="اسناد">
