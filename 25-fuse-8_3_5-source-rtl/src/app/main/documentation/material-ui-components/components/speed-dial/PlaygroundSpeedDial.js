...
const actions = [
  { icon: <FileCopyIcon />, name: 'کپی' },
  { icon: <SaveIcon />, name: 'ذخیره' },
  { icon: <PrintIcon />, name: 'پرینت' },
  { icon: <ShareIcon />, name: 'اشتراک گذاری' },
];
    ...
    <Box sx={{ transform: 'translateZ(0px)', flexGrow: 1 }}>
      ...
      <FormControl component="fieldset" sx={{ mt: 1, display: 'flex' }}>
        ...
        <RadioGroup
          ...
          row
        >
          <FormControlLabel value="up" control={<Radio />} label="بالا" />
          <FormControlLabel value="right" control={<Radio />} label="راست" />
          <FormControlLabel value="down" control={<Radio />} label="پایین" />
