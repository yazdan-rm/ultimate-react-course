      ...
      <Box sx={{ height: 400, overflow: 'auto', mb: 3 }}>
        ...
        >
          ...
          تغییر وضعیت پاپر
            ...
            برای آزمایش با اصلاح‌کننده‌های flip و preventOverflow، در اطراف این کانتینر اسکرول کنید.
            </Typography>
            <Popper
              id={id}
              open={open}
            ...
            >
              <div>
                ...
                <Paper sx={{ maxWidth: 400, overflow: 'auto' }}>
                  <DialogTitle>{"از سرویس مکان گوگل استفاده میکنید"}</DialogTitle>
                  <DialogContent>
                    <DialogContentText>
                    به Google اجازه دهید به برنامه‌ها در تعیین مکان کمک کند.
                    </DialogContentText>
                  </DialogContent>
                  <DialogActions>
                    <Button onClick={handleClickButton}>مخالفم</Button>
                    <Button onClick={handleClickButton}>موافقم</Button>
                  </DialogActions>
                </Paper>
              </div>
            </Popper>
        ...
        <Grid container item xs={12}>
          ...
          <Grid item xs={6}>
            <TextField
              ...
              variant="standard"
            >
              <option value="top-start">بالا-شروع</option>
              <option value="top">بالا</option>
              <option value="top-end">بالا-انتها</option>
              <option value="left-start">راست-شروع</option>
              <option value="left">راست</option>
              <option value="left-end">راست-انتها</option>
              <option value="right-start">چپ-شروع</option>
              <option value="right">چپ</option>
              <option value="right-end">چپ-انتها</option>
              <option value="bottom-start">پایین-شروع</option>
              <option value="bottom">پایین</option>
              <option value="bottom-end">پایین-انتها</option>
            </TextField>
          </Grid>
          <Grid item xs={6}>
            <FormControlLabel
            ...
            (فرزندان در سلسله مراتب DOM والدین خود باقی می مانند)
            </Typography>
          </Grid>
        </Grid>
        <Grid item xs={12}>
          <Typography variant="h6" component="div">
          اصلاح‌کننده‌ها (گزینه‌هایی از Popper.js)
          </Typography>
        </Grid>
        <Grid container item xs={12} spacing={1}>
          <Grid item xs={6}>
            <FormGroup>
              <Typography variant="subtitle1">جلوگیری از overflow</Typography>
              <FormControlLabel
                control={
                  <Switch
              ...
              >
                ...
                <option value="viewport">ویوپورت</option>
              </TextField>
            </FormGroup>
          </Grid>
          <Grid item xs={6}>
            <FormGroup>
              <Typography variant="subtitle1">چرخش</Typography>
              <FormControlLabel
                control={
                  <Switch
            ...
            <FormGroup>
              <Typography variant="subtitle1">فلش</Typography>
              <FormControlLabel
                control={
                  <Switch
                    checked={arrow}
