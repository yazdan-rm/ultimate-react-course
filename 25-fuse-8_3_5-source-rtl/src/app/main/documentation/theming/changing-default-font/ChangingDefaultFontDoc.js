...
function ChangingDefaultFontDoc() {
  return (
    <>
      ...
      دو راه برای افزودن font-family وجود دارد.
      </Typography>

      <ul className="list-decimal ml-16">
        <li>
          <Typography className="mb-24">
          می توانید پیوند فونت را در ابتدای  the public/index.html اضافه کنید.
          </Typography>
      ...
      باید مقادیر <code>typography.fontFamily</code> را به پیکربندی تم مورد نظر در <code>app/configs/themesConfig </code>اضافه کنید.
      ...
      <Typography className="mt-16 mb-8" component="p">
      همچنین تخصیص خانواده فونت در <code>src/styles/app-base.css </code> وجود دارد
      </Typography>
      ...
      <FuseHighlight component="pre" className="language-css mb-24">
        {`
					html {
						font-size: 62.5%;
            font-family: 'yekan', Roboto, Helvetica Neue, Arial, sans-serif;
