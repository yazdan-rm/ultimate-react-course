            ...
            >
              <motion.div variants={item}>
                <SimplePricingCard
                  ...
                  period={period}
                  title="شخصی"
                  subtitle="ایده آل برای یک فرد یا یک تیم کوچک که شروع به بزرگتر شدن می کند"
                  yearlyPrice="$9"
                  monthlyPrice="$6"
                  buttonTitle="آزمایش خود را شروع کنید"
                  details={
                    <div className="mt-32 space-y-8">
                      ...
                      <Typography className="ml-2 leading-5">اپلیکیشن موبایل رایگان  </Typography>
                      <Typography className="ml-2 leading-5">دسترسی به انجمن ها</Typography>
                    </div>
                  }
                />
              </motion.div>
                ...
                <SimplePricingCard
                  ...
                  details={
                    <div className="mt-32 space-y-8">
                      ...
                      <Typography className="ml-2 leading-5">پشتیبانی 12/5</Typography>
                    </div>
                  }
                  isPopular
                />
