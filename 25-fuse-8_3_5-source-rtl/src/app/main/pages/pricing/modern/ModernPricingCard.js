  ...
  return (
    ...
    >
      ...
      <div className="flex items-baseline whitespace-nowrap">
        <Typography className="mr-8 text-2xl">تومان</Typography>
      ...
      <Typography className="flex flex-col mt-8" color="text.secondary">
        {period === 'month' && (
          <>
            <span>صورتحساب ماهانه</span>
            <span>
              <b>{yearlyPrice}</b> صورتحساب سالانه
            </span>
          </>
        )}
        {period === 'year' && (
          <>
            <span>صورتحساب سالانه</span>
            <span>
              <b>{monthlyPrice}</b> صورتحساب ماهانه
            </span>
          </>
        )}
      </Typography>
