...
const schema = yup.object().shape({
  title: yup.string().required('شما باید یک نام وارد کنید'),
});
          ...
          <Controller
            ...
            render={({ field: { value, onChange } }) => (
              <Button className="font-semibold" onClick={() => onChange(!value)}>
                ...
                <span className="mx-8">
                  {task.completed ? 'علامت گذاری به عنوان ناتمام' : 'علامت گذاری به عنوان تمام شده'}
                </span>
              </Button>
            )}
          />
        ...
        <Controller
          ...
          render={({ field }) => (
            <TextField
              ...
              {...field}
              label={`${_.upperFirst(form.type)} عنوان`}
        ...
        <Controller
          ...
          render={({ field: { onChange, value } }) => (
            <Autocomplete
              ...
              fullWidth
              renderInput={(params) => <TextField {...params} label="برچسب ها" placeholder="برچسب" />}
            />
          )}
        />
