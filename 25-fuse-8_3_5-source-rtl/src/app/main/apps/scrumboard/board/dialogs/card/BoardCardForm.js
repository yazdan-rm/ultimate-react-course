      ...
      <div className="flex flex-auto flex-col py-16 px-0 sm:px-16">
        ...
        {cardForm.labels && cardForm.labels.length > 0 && (
          <div className="flex-1 mb-24 mx-8">
            <div className="flex items-center mt-16 mb-12">
              ...
              <Typography className="font-semibold text-16 mx-8">برچسب ها</Typography>
            </div>
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  {...params}
                  placeholder="چند برچسب را انتخاب کنید"
                  label="Labels"
                  variant="outlined"
                  InputLabelProps={{
                    shrink: true,
        ...
        {cardForm.memberIds && cardForm.memberIds.length > 0 && (
          <div className="flex-1 mb-24 mx-8">
            <div className="flex items-center mt-16 mb-12">
              ...
              <Typography className="font-semibold text-16 mx-8">اعضا</Typography>
            </div>
            <Autocomplete
              className="mt-8 mb-16"
              multiple
              ...
              renderInput={(params) => (
                <TextField
                  {...params}
                  placeholder="چند اعضا را انتخاب کنید"
                  label="Members"
                  variant="outlined"
                  InputLabelProps={{
                    shrink: true,
        ...
        {cardForm.attachments && cardForm.attachments.length > 0 && (
          <div className="mb-24">
            <div className="flex items-center mt-16 mb-12">
              ...
              <Typography className="font-semibold text-16 mx-8">پیوست ها</Typography>
            </div>
        ...
        <div className="mb-24">
          <div className="flex items-center mt-16 mb-12">
            ...
            <Typography className="font-semibold text-16 mx-8">نظرات</Typography>
          </div>
          <div>
            <CardComment
              ...
              {value.length > 0 && (
                <div className="mb-24">
                  <div className="flex items-center mt-16">
                    ...
                    <Typography className="font-semibold text-16 mx-8">فعالیت</Typography>
                  </div>
                  <List className="">
                    {value.map((item) => (
