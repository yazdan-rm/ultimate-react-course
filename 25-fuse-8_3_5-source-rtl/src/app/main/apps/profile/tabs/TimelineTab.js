            ...
            <Card component={motion.div} variants={item} key={post.id} className="mb-32">
              <CardHeader
                ...
                title={
                  <span className="flex items-center space-x-8">
                    ...
                    <span>
                      {post.type === 'post' && 'در تایم لاین شما ارسال شده است'}
                      {post.type === 'something' && 'محتوایی با را شما اشتراک گذاشت'}
                      {post.type === 'video' && 'یک ویدیو با شما به اشتراک گذاشت'}
              ...
              <CardActions disableSpacing className="px-32">
                ...
                <Button aria-label="Share">
                  ...
                  <Typography className="mx-4">بازنشر</Typography>
