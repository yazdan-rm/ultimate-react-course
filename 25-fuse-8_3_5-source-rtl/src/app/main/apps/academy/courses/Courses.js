        ...
        >
          <div className="flex flex-col items-center justify-center  mx-auto w-full">
            ...
            >
              ...
              >
                دوره های ما شما را در فرآیند ساخت برنامه های کوچک یا افزودن ویژگی های جدید به برنامه های موجود گام به گام همراهی میکنند
              </Typography>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col shrink-0 sm:flex-row items-center justify-between space-y-16 sm:space-y-0">
            <div className="flex flex-col sm:flex-row w-full sm:w-auto items-center space-y-16 sm:space-y-0 sm:space-x-16">
              <FormControl className="flex w-full sm:w-136" variant="outlined">
                <InputLabel id="category-select-label">موضوع</InputLabel>
                <Select
              ...
              <TextField
                label="جستجو برای یک دوره"
                placeholder="کلمه کلیدی یا چیزی که دنبالشی وارد کن..."
            ...
            <FormControlLabel
              label="مخفی کردن دوره های تکمیل شده"
              control={
                <Switch
                  onChange={(ev) => {
