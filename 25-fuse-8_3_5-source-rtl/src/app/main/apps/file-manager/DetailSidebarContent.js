...
function DetailSidebarContent(props) {
  ...
  return (
    ...
    >
      ...
      <div className="text-16 font-medium mt-32">اطلاعات</div>
      <div className="flex flex-col mt-16 border-t border-b divide-y font-medium">
        <div className="flex items-center justify-between py-12">
          <Typography color="text.secondary">ساخته شده توسط</Typography>
          <Typography>{item.createdBy}</Typography>
        </div>
        <div className="flex items-center justify-between py-12">
          <Typography color="text.secondary">ایجاد شده در</Typography>
          <Typography>{item.createdAt}</Typography>
        </div>
        <div className="flex items-center justify-between py-12">
          <Typography color="text.secondary">اصلاع شده در</Typography>
          <Typography>{item.modifiedAt}</Typography>
        </div>
        <div className="flex items-center justify-between py-12">
          <Typography color="text.secondary">اندازه</Typography>
          <Typography>{item.size}</Typography>
        </div>
        {item.contents && (
          <div className="flex items-center justify-between py-12">
            <Typography color="text.secondary">فهرست</Typography>
      ...
      {item.description && (
        <>
          <div className="text-16 font-medium mt-32 pb-16 border-b">توضیحات</div>
