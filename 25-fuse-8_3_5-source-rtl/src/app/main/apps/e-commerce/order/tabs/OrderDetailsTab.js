      ...
      <div className="pb-48">
        ...
        <div className="mb-24">
            ...
            <table className="simple">
              <thead>
                <tr>
                  ...
                  <th>
                    <Typography className="font-semibold">کمپانی</Typography>
                  </th>
                </tr>
              </thead>
              <tbody>
          ...
          >
            ...
            >
              <Typography className="font-semibold">آدرس حمل و نقل</Typography>
            </AccordionSummary>
          ...
          >
            <AccordionSummary
              ...
              classes={{ root: 'border border-solid rounded-16 mb-16' }}
            >
              <Typography className="font-semibold">آدرس صورتحساب</Typography>
            </AccordionSummary>
            <AccordionDetails className="flex flex-col md:flex-row -mx-8">
              <Typography className="w-full md:max-w-256 mb-16 md:mb-0 mx-8 text-16">
          ...
          <table className="simple">
            <thead>
              <tr>
                ...
                <th>
                  <Typography className="font-semibold">به روز شده در </Typography>
                </th>
              </tr>
            </thead>
            <tbody>
        ...
        <div className="table-responsive">
          <table className="simple">
            <thead>
              <tr>
                <th>
                  <Typography className="font-semibold">شناسه تراکنش</Typography>
                </th>
                <th>
                  <Typography className="font-semibold">روش پرداخت</Typography>
                </th>
                <th>
                  <Typography className="font-semibold">میزان</Typography>
                </th>
                <th>
