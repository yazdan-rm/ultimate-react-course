...
const schema = yup.object().shape({
  action: yup.string().required('شما باید یک مقدار را انتخاب کنید'),
  wallet: yup.string().required('شما باید یک مقدار را انتخاب کنید'),
  amount: yup.number().typeError('باید مقدار عددی را مشخص کنید').moreThan(0).nullable(true),
});
