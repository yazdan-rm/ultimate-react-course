        ...
        <div className="flex flex-col">
          ...
          <div className="flex-auto grid grid-cols-4 gap-16 mt-24">
            <div className="col-span-2 flex flex-col items-center justify-center py-32 px-4 rounded-2xl bg-indigo-50 text-indigo-800">
              ...
              <Typography className="mt-4 text-sm sm:text-lg font-medium">Issueهای جدید</Typography>
            </div>
            <div className="col-span-2 flex flex-col items-center justify-center py-32 px-4 rounded-2xl bg-green-50 text-green-800">
              ...
              <Typography className="mt-4 text-sm sm:text-lg font-medium">بسته شده</Typography>
            </div>
            <Box
              sx={{
            ...
            >
              ...
              <Typography className="mt-4 text-sm font-medium text-center">حل شده</Typography>
            </Box>
            <Box
              sx={{
                backgroundColor: (_theme) =>
            ...
            >
              ...
              <Typography className="mt-4 text-sm font-medium text-center">نیاز به بررسی</Typography>
            </Box>
            <Box
              sx={{
                backgroundColor: (_theme) =>
            ...
            >
              ...
              <Typography className="mt-4 text-sm font-medium text-center">بازگشایی شده</Typography>
            </Box>
            <Box
              sx={{
                backgroundColor: (_theme) =>
            ...
            >
              ...
              <Typography className="mt-4 text-sm font-medium text-center">نیازمند Triage</Typography>
            </Box>
          </div>
        </div>
      </div>
