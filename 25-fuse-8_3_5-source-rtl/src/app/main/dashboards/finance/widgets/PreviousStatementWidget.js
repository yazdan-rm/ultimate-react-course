      ...
      <div className="flex flex-row flex-wrap mt-16 -mx-24">
        <div className="flex flex-col mx-24 my-12">
          ...
          <Typography className="mt-8 font-medium text-3xl leading-none">
            ...
            {Math.floor(limit).toLocaleString()}&nbsp;<small className="text-sm">ملیون تومان</small>
          </Typography>
        </div>
        <div className="flex flex-col mx-24 my-12">
          <Typography color="text.secondary" className="text-sm font-medium leading-none">
          ...
          <Typography className="mt-8 font-medium text-3xl leading-none">
            ...
            {Math.floor(spent).toLocaleString()}&nbsp;<small className="text-sm">ملیون تومان</small>
          </Typography>
        </div>
        <div className="flex flex-col mx-24 my-12">
          <Typography color="text.secondary" className="text-sm font-medium leading-none">
          ...
          <Typography className="mt-8 font-medium text-3xl leading-none">
            ...
            {Math.floor(minimum).toLocaleString()}&nbsp;<small className="text-sm">ملیون تومان</small>
          </Typography>
        </div>
      </div>
