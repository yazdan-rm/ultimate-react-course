  ...
  return (
    <Paper className="flex flex-col flex-auto p-24 shadow rounded-2xl overflow-hidden">
      ...
      <Typography className="mt-24">
        ماه گذشته؛ شما <strong>223</strong> تراکنش هزینه، <strong>12</strong> پس انداز داشته اید
        ورودی ها و <strong>4</strong> صورت حساب.
      </Typography>
      ...
      <div className="my-32 space-y-32">
          ...
          <div className="flex items-center space-x-16">
            ...
            <div className="flex-auto leading-none">
              ...
              <Typography className="font-medium text-20">
                ...
                {Math.floor(expenses).toLocaleString()}&nbsp;<small className="text-sm">ملیون تومان</small>
              </Typography>
              <LinearProgress
                variant="determinate"
                className="mt-4"
          ...
          <div className="flex items-center space-x-16">
            ...
            <div className="flex-auto leading-none">
              ...
              <Typography className="font-medium text-20">
                ...
                {Math.floor(savings).toLocaleString()}&nbsp;<small className="text-sm">ملیون تومان</small>
              </Typography>
              <LinearProgress
                variant="determinate"
                className="mt-4"
        ...
        <div className="flex flex-col">
          <div className="flex items-center space-x-16">
            ...
            <div className="flex-auto leading-none">
              ...
              <Typography className="font-medium text-20">
                ...
                {Math.floor(bills).toLocaleString()}&nbsp;<small className="text-sm">ملیون تومان</small>
              </Typography>
              <LinearProgress
                variant="determinate"
                className="mt-4"
          ...
          <Typography className="mt-12 text-md" color="text.secondary">
            مخارج شما از حد تصور فراتر رفته است! ماه آینده مراقب باشید.
          </Typography>
        </div>
      </div>

      <div className="">
        <Button variant="outlined">دانلود گزارش بودجه</Button>
      </div>
    </Paper>
  );
}
