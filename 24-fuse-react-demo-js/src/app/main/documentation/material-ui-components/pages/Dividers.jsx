...
import IntroDividerRaw from '../components/dividers/IntroDivider.jsx?raw';
import DividerVariantsComponent from '../components/dividers/DividerVariants';
import DividerVariantsRaw from '../components/dividers/DividerVariants.jsx?raw';
import VerticalDividersComponent from '../components/dividers/VerticalDividers';
import VerticalDividersRaw from '../components/dividers/VerticalDividers.jsx?raw';
import FlexDividerComponent from '../components/dividers/FlexDivider';
import FlexDividerRaw from '../components/dividers/FlexDivider.jsx?raw';
import DividerTextComponent from '../components/dividers/DividerText';
import DividerTextRaw from '../components/dividers/DividerText.jsx?raw';
import ListDividersComponent from '../components/dividers/ListDividers';
import ListDividersRaw from '../components/dividers/ListDividers.jsx?raw';
import VerticalDividerMiddleComponent from '../components/dividers/VerticalDividerMiddle';
import VerticalDividerMiddleRaw from '../components/dividers/VerticalDividerMiddle.jsx?raw';
function DividersDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/dividers" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="IntroDivider.js" className="my-16" iframe={false} component={IntroDividerComponent} raw={IntroDividerRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Basics
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DividerVariants.js" className="my-16" iframe={false} component={DividerVariantsComponent} raw={DividerVariantsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Orientation
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="VerticalDividers.js" className="my-16" iframe={false} component={VerticalDividersComponent} raw={VerticalDividersRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Flex item
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FlexDivider.js" className="my-16" iframe={false} component={FlexDividerComponent} raw={FlexDividerRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				With children
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DividerText.js" className="my-16" iframe={false} component={DividerTextComponent} raw={DividerTextRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ListDividers.js" className="my-16" iframe={false} component={ListDividersComponent} raw={ListDividersRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Icon grouping
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="VerticalDividerMiddle.js" className="my-16" iframe={false} component={VerticalDividerMiddleComponent} raw={VerticalDividerMiddleRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Accessibility
			</Typography>
