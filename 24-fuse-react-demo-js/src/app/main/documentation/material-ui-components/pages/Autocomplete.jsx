...
import ComboBoxRaw from '../components/autocomplete/ComboBox.jsx?raw';
import PlaygroundComponent from '../components/autocomplete/Playground';
import PlaygroundRaw from '../components/autocomplete/Playground.jsx?raw';
import CountrySelectComponent from '../components/autocomplete/CountrySelect';
import CountrySelectRaw from '../components/autocomplete/CountrySelect.jsx?raw';
import ControllableStatesComponent from '../components/autocomplete/ControllableStates';
import ControllableStatesRaw from '../components/autocomplete/ControllableStates.jsx?raw';
import FreeSoloComponent from '../components/autocomplete/FreeSolo';
import FreeSoloRaw from '../components/autocomplete/FreeSolo.jsx?raw';
import FreeSoloCreateOptionComponent from '../components/autocomplete/FreeSoloCreateOption';
import FreeSoloCreateOptionRaw from '../components/autocomplete/FreeSoloCreateOption.jsx?raw';
import FreeSoloCreateOptionDialogComponent from '../components/autocomplete/FreeSoloCreateOptionDialog';
import FreeSoloCreateOptionDialogRaw from '../components/autocomplete/FreeSoloCreateOptionDialog.jsx?raw';
import GroupedComponent from '../components/autocomplete/Grouped';
import GroupedRaw from '../components/autocomplete/Grouped.jsx?raw';
import RenderGroupComponent from '../components/autocomplete/RenderGroup';
import RenderGroupRaw from '../components/autocomplete/RenderGroup.jsx?raw';
import DisabledOptionsComponent from '../components/autocomplete/DisabledOptions';
import DisabledOptionsRaw from '../components/autocomplete/DisabledOptions.jsx?raw';
import UseAutocompleteComponent from '../components/autocomplete/UseAutocomplete';
import UseAutocompleteRaw from '../components/autocomplete/UseAutocomplete.jsx?raw';
import CustomizedHookComponent from '../components/autocomplete/CustomizedHook';
import CustomizedHookRaw from '../components/autocomplete/CustomizedHook.jsx?raw';
import AsynchronousComponent from '../components/autocomplete/Asynchronous';
import AsynchronousRaw from '../components/autocomplete/Asynchronous.jsx?raw';
import GoogleMapsComponent from '../components/autocomplete/GoogleMaps';
import GoogleMapsRaw from '../components/autocomplete/GoogleMaps.jsx?raw';
import TagsComponent from '../components/autocomplete/Tags';
import TagsRaw from '../components/autocomplete/Tags.jsx?raw';
import FixedTagsComponent from '../components/autocomplete/FixedTags';
import FixedTagsRaw from '../components/autocomplete/FixedTags.jsx?raw';
import CheckboxesTagsComponent from '../components/autocomplete/CheckboxesTags';
import CheckboxesTagsRaw from '../components/autocomplete/CheckboxesTags.jsx?raw';
import LimitTagsComponent from '../components/autocomplete/LimitTags';
import LimitTagsRaw from '../components/autocomplete/LimitTags.jsx?raw';
import SizesComponent from '../components/autocomplete/Sizes';
import SizesRaw from '../components/autocomplete/Sizes.jsx?raw';
import CustomInputAutocompleteComponent from '../components/autocomplete/CustomInputAutocomplete';
import CustomInputAutocompleteRaw from '../components/autocomplete/CustomInputAutocomplete.jsx?raw';
import GloballyCustomizedOptionsComponent from '../components/autocomplete/GloballyCustomizedOptions';
import GloballyCustomizedOptionsRaw from '../components/autocomplete/GloballyCustomizedOptions.jsx?raw';
import GitHubLabelComponent from '../components/autocomplete/GitHubLabel';
import GitHubLabelRaw from '../components/autocomplete/GitHubLabel.jsx?raw';
import AutocompleteHintComponent from '../components/autocomplete/AutocompleteHint';
import AutocompleteHintRaw from '../components/autocomplete/AutocompleteHint.jsx?raw';
import HighlightsComponent from '../components/autocomplete/Highlights';
import HighlightsRaw from '../components/autocomplete/Highlights.jsx?raw';
import FilterComponent from '../components/autocomplete/Filter';
import FilterRaw from '../components/autocomplete/Filter.jsx?raw';
import VirtualizeComponent from '../components/autocomplete/Virtualize';
import VirtualizeRaw from '../components/autocomplete/Virtualize.jsx?raw';
function AutocompleteDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/autocomplete" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ComboBox.js" className="my-16" iframe={false} component={ComboBoxComponent} raw={ComboBoxRaw}/>
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Playground.js" className="my-16" iframe={false} component={PlaygroundComponent} raw={PlaygroundRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Country select
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CountrySelect.js" className="my-16" iframe={false} component={CountrySelectComponent} raw={CountrySelectRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Controlled states
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ControllableStates.js" className="my-16" iframe={false} component={ControllableStatesComponent} raw={ControllableStatesRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				:::warning
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FreeSolo.js" className="my-16" iframe={false} component={FreeSoloComponent} raw={FreeSoloRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FreeSoloCreateOption.js" className="my-16" iframe={false} component={FreeSoloCreateOptionComponent} raw={FreeSoloCreateOptionRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				You could also display a dialog when the user wants to add a new value.
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FreeSoloCreateOptionDialog.js" className="my-16" iframe={false} component={FreeSoloCreateOptionDialogComponent} raw={FreeSoloCreateOptionDialogRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Grouped
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Grouped.js" className="my-16" iframe={false} component={GroupedComponent} raw={GroupedRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="RenderGroup.js" className="my-16" iframe={false} component={RenderGroupComponent} raw={RenderGroupRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Disabled options
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DisabledOptions.js" className="my-16" iframe={false} component={DisabledOptionsComponent} raw={DisabledOptionsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="UseAutocomplete.js" className="my-16" iframe={false} component={UseAutocompleteComponent} raw={UseAutocompleteRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Customized hook
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedHook.js" className="my-16" iframe={false} component={CustomizedHookComponent} raw={CustomizedHookRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Asynchronous.js" className="my-16" iframe={false} component={AsynchronousComponent} raw={AsynchronousRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Search as you type
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="GoogleMaps.js" className="my-16" iframe={false} component={GoogleMapsComponent} raw={GoogleMapsRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Tags.js" className="my-16" iframe={false} component={TagsComponent} raw={TagsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Fixed options
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FixedTags.js" className="my-16" iframe={false} component={FixedTagsComponent} raw={FixedTagsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Checkboxes
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CheckboxesTags.js" className="my-16" iframe={false} component={CheckboxesTagsComponent} raw={CheckboxesTagsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Limit tags
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="LimitTags.js" className="my-16" iframe={false} component={LimitTagsComponent} raw={LimitTagsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Sizes
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Sizes.js" className="my-16" iframe={false} component={SizesComponent} raw={SizesRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomInputAutocomplete.js" className="my-16" iframe={false} component={CustomInputAutocompleteComponent} raw={CustomInputAutocompleteRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="GloballyCustomizedOptions.js" className="my-16" iframe={false} component={GloballyCustomizedOptionsComponent} raw={GloballyCustomizedOptionsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				GitHub&#39;s picker
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="GitHubLabel.js" className="my-16" iframe={false} component={GitHubLabelComponent} raw={GitHubLabelRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="AutocompleteHint.js" className="my-16" iframe={false} component={AutocompleteHintComponent} raw={AutocompleteHintRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Highlights
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Highlights.js" className="my-16" iframe={false} component={HighlightsComponent} raw={HighlightsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Custom filter
			</Typography>
...
`}
			...
			<Typography className="text-14 mt-12 mb-10" component="h4">
				Arguments
			</Typography>
			<ol>
				<li>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Filter.js" className="my-16" iframe={false} component={FilterComponent} raw={FilterRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Advanced
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Virtualize.js" className="my-16" iframe={false} component={VirtualizeComponent} raw={VirtualizeRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Events
			</Typography>
