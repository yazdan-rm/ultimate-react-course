...
import BasicStackRaw from '../components/stack/BasicStack.jsx?raw';
import DirectionStackComponent from '../components/stack/DirectionStack';
import DirectionStackRaw from '../components/stack/DirectionStack.jsx?raw';
import DividerStackComponent from '../components/stack/DividerStack';
import DividerStackRaw from '../components/stack/DividerStack.jsx?raw';
import ResponsiveStackComponent from '../components/stack/ResponsiveStack';
import ResponsiveStackRaw from '../components/stack/ResponsiveStack.jsx?raw';
import FlexboxGapStackComponent from '../components/stack/FlexboxGapStack';
import FlexboxGapStackRaw from '../components/stack/FlexboxGapStack.jsx?raw';
import InteractiveStackComponent from '../components/stack/InteractiveStack';
import InteractiveStackRaw from '../components/stack/InteractiveStack.jsx?raw';
import ZeroWidthStackComponent from '../components/stack/ZeroWidthStack';
import ZeroWidthStackRaw from '../components/stack/ZeroWidthStack.jsx?raw';
function StackDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/stack" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BasicStack.js" className="my-16" iframe={false} component={BasicStackComponent} raw={BasicStackRaw}/>
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DirectionStack.js" className="my-16" iframe={false} component={DirectionStackComponent} raw={DirectionStackRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Dividers
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DividerStack.js" className="my-16" iframe={false} component={DividerStackComponent} raw={DividerStackRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Responsive values
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ResponsiveStack.js" className="my-16" iframe={false} component={ResponsiveStackComponent} raw={ResponsiveStackRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Flexbox gap
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FlexboxGapStack.js" className="my-16" iframe={false} component={FlexboxGapStackComponent} raw={FlexboxGapStackRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="InteractiveStack.js" className="my-16" iframe={false} component={InteractiveStackComponent} raw={InteractiveStackRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				System props
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ZeroWidthStack.js" className="my-16" iframe={false} component={ZeroWidthStackComponent} raw={ZeroWidthStackRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Anatomy
			</Typography>
