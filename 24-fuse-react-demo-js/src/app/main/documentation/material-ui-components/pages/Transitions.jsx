...
import SimpleCollapseRaw from '../components/transitions/SimpleCollapse.jsx?raw';
import SimpleFadeComponent from '../components/transitions/SimpleFade';
import SimpleFadeRaw from '../components/transitions/SimpleFade.jsx?raw';
import SimpleGrowComponent from '../components/transitions/SimpleGrow';
import SimpleGrowRaw from '../components/transitions/SimpleGrow.jsx?raw';
import SimpleSlideComponent from '../components/transitions/SimpleSlide';
import SimpleSlideRaw from '../components/transitions/SimpleSlide.jsx?raw';
import SlideFromContainerComponent from '../components/transitions/SlideFromContainer';
import SlideFromContainerRaw from '../components/transitions/SlideFromContainer.jsx?raw';
import SimpleZoomComponent from '../components/transitions/SimpleZoom';
import SimpleZoomRaw from '../components/transitions/SimpleZoom.jsx?raw';
import TransitionGroupExampleComponent from '../components/transitions/TransitionGroupExample';
import TransitionGroupExampleRaw from '../components/transitions/TransitionGroupExample.jsx?raw';
function TransitionsDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/transitions" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SimpleCollapse.js" className="my-16" iframe={false} component={SimpleCollapseComponent} raw={SimpleCollapseRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Fade
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SimpleFade.js" className="my-16" iframe={false} component={SimpleFadeComponent} raw={SimpleFadeRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Grow
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SimpleGrow.js" className="my-16" iframe={false} component={SimpleGrowComponent} raw={SimpleGrowRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Slide
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SimpleSlide.js" className="my-16" iframe={false} component={SimpleSlideComponent} raw={SimpleSlideRaw}/>
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SlideFromContainer.js" className="my-16" iframe={false} component={SlideFromContainerComponent} raw={SlideFromContainerRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Zoom
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SimpleZoom.js" className="my-16" iframe={false} component={SimpleZoomComponent} raw={SimpleZoomRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Child requirement
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TransitionGroupExample.js" className="my-16" iframe={false} component={TransitionGroupExampleComponent} raw={TransitionGroupExampleRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
