...
import VariantsRaw from '../components/skeleton/Variants.jsx?raw';
import AnimationsComponent from '../components/skeleton/Animations';
import AnimationsRaw from '../components/skeleton/Animations.jsx?raw';
import YouTubeComponent from '../components/skeleton/YouTube';
import YouTubeRaw from '../components/skeleton/YouTube.jsx?raw';
import FacebookComponent from '../components/skeleton/Facebook';
import FacebookRaw from '../components/skeleton/Facebook.jsx?raw';
import SkeletonTypographyComponent from '../components/skeleton/SkeletonTypography';
import SkeletonTypographyRaw from '../components/skeleton/SkeletonTypography.jsx?raw';
import SkeletonChildrenComponent from '../components/skeleton/SkeletonChildren';
import SkeletonChildrenRaw from '../components/skeleton/SkeletonChildren.jsx?raw';
import SkeletonColorComponent from '../components/skeleton/SkeletonColor';
import SkeletonColorRaw from '../components/skeleton/SkeletonColor.jsx?raw';
function SkeletonDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/skeleton" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Variants.js" className="my-16" iframe={false} component={VariantsComponent} raw={VariantsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Animations
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Animations.js" className="my-16" iframe={false} component={AnimationsComponent} raw={AnimationsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Pulsate example
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="YouTube.js" className="my-16" iframe={false} component={YouTubeComponent} raw={YouTubeRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Wave example
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Facebook.js" className="my-16" iframe={false} component={FacebookComponent} raw={FacebookRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SkeletonTypography.js" className="my-16" iframe={false} component={SkeletonTypographyComponent} raw={SkeletonTypographyRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SkeletonChildren.js" className="my-16" iframe={false} component={SkeletonChildrenComponent} raw={SkeletonChildrenRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Color
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SkeletonColor.js" className="my-16" iframe={false} component={SkeletonColorComponent} raw={SkeletonColorRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Accessibility
			</Typography>
