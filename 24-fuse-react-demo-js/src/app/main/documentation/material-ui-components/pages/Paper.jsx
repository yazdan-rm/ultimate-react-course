...
import SimplePaperRaw from '../components/paper/SimplePaper.jsx?raw';
import ElevationComponent from '../components/paper/Elevation';
import ElevationRaw from '../components/paper/Elevation.jsx?raw';
import VariantsComponent from '../components/paper/Variants';
import VariantsRaw from '../components/paper/Variants.jsx?raw';
import SquareCornersComponent from '../components/paper/SquareCorners';
import SquareCornersRaw from '../components/paper/SquareCorners.jsx?raw';
function PaperDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/paper" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SimplePaper.js" className="my-16" iframe={false} component={SimplePaperComponent} raw={SimplePaperRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Component
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Elevation.js" className="my-16" iframe={false} component={ElevationComponent} raw={ElevationRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Variants
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SquareCorners.js" className="my-16" iframe={false} component={SquareCornersComponent} raw={SquareCornersRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Anatomy
			</Typography>
