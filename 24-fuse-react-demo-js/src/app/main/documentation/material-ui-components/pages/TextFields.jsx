...
import BasicTextFieldsRaw from '../components/text-fields/BasicTextFields.jsx?raw';
import FormPropsTextFieldsComponent from '../components/text-fields/FormPropsTextFields';
import FormPropsTextFieldsRaw from '../components/text-fields/FormPropsTextFields.jsx?raw';
import ValidationTextFieldsComponent from '../components/text-fields/ValidationTextFields';
import ValidationTextFieldsRaw from '../components/text-fields/ValidationTextFields.jsx?raw';
import MultilineTextFieldsComponent from '../components/text-fields/MultilineTextFields';
import MultilineTextFieldsRaw from '../components/text-fields/MultilineTextFields.jsx?raw';
import SelectTextFieldsComponent from '../components/text-fields/SelectTextFields';
import SelectTextFieldsRaw from '../components/text-fields/SelectTextFields.jsx?raw';
import InputWithIconComponent from '../components/text-fields/InputWithIcon';
import InputWithIconRaw from '../components/text-fields/InputWithIcon.jsx?raw';
import InputAdornmentsComponent from '../components/text-fields/InputAdornments';
import InputAdornmentsRaw from '../components/text-fields/InputAdornments.jsx?raw';
import TextFieldSizesComponent from '../components/text-fields/TextFieldSizes';
import TextFieldSizesRaw from '../components/text-fields/TextFieldSizes.jsx?raw';
import TextFieldHiddenLabelComponent from '../components/text-fields/TextFieldHiddenLabel';
import TextFieldHiddenLabelRaw from '../components/text-fields/TextFieldHiddenLabel.jsx?raw';
import LayoutTextFieldsComponent from '../components/text-fields/LayoutTextFields';
import LayoutTextFieldsRaw from '../components/text-fields/LayoutTextFields.jsx?raw';
import FullWidthTextFieldComponent from '../components/text-fields/FullWidthTextField';
import FullWidthTextFieldRaw from '../components/text-fields/FullWidthTextField.jsx?raw';
import StateTextFieldsComponent from '../components/text-fields/StateTextFields';
import StateTextFieldsRaw from '../components/text-fields/StateTextFields.jsx?raw';
import ComposedTextFieldComponent from '../components/text-fields/ComposedTextField';
import ComposedTextFieldRaw from '../components/text-fields/ComposedTextField.jsx?raw';
import InputsComponent from '../components/text-fields/Inputs';
import InputsRaw from '../components/text-fields/Inputs.jsx?raw';
import ColorTextFieldsComponent from '../components/text-fields/ColorTextFields';
import ColorTextFieldsRaw from '../components/text-fields/ColorTextFields.jsx?raw';
import CustomizedInputsStyledComponent from '../components/text-fields/CustomizedInputsStyled';
import CustomizedInputsStyledRaw from '../components/text-fields/CustomizedInputsStyled.jsx?raw';
import CustomizedInputsStyleOverridesComponent from '../components/text-fields/CustomizedInputsStyleOverrides';
import CustomizedInputsStyleOverridesRaw from '../components/text-fields/CustomizedInputsStyleOverrides.jsx?raw';
import CustomizedInputBaseComponent from '../components/text-fields/CustomizedInputBase';
import CustomizedInputBaseRaw from '../components/text-fields/CustomizedInputBase.jsx?raw';
import UseFormControlComponent from '../components/text-fields/UseFormControl';
import UseFormControlRaw from '../components/text-fields/UseFormControl.jsx?raw';
import HelperTextMisalignedComponent from '../components/text-fields/HelperTextMisaligned';
import HelperTextMisalignedRaw from '../components/text-fields/HelperTextMisaligned.jsx?raw';
import HelperTextAlignedComponent from '../components/text-fields/HelperTextAligned';
import HelperTextAlignedRaw from '../components/text-fields/HelperTextAligned.jsx?raw';
import FormattedInputsComponent from '../components/text-fields/FormattedInputs';
import FormattedInputsRaw from '../components/text-fields/FormattedInputs.jsx?raw';
function TextFieldsDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/text-fields" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BasicTextFields.js" className="my-16" iframe={false} component={BasicTextFieldsComponent} raw={BasicTextFieldsRaw}/>
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FormPropsTextFields.js" className="my-16" iframe={false} component={FormPropsTextFieldsComponent} raw={FormPropsTextFieldsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Validation
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ValidationTextFields.js" className="my-16" iframe={false} component={ValidationTextFieldsComponent} raw={ValidationTextFieldsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Multiline
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="MultilineTextFields.js" className="my-16" iframe={false} component={MultilineTextFieldsComponent} raw={MultilineTextFieldsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Select
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SelectTextFields.js" className="my-16" iframe={false} component={SelectTextFieldsComponent} raw={SelectTextFieldsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Icons
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="InputWithIcon.js" className="my-16" iframe={false} component={InputWithIconComponent} raw={InputWithIconRaw}/>
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="InputAdornments.js" className="my-16" iframe={false} component={InputAdornmentsComponent} raw={InputAdornmentsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Sizes
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TextFieldSizes.js" className="my-16" iframe={false} component={TextFieldSizesComponent} raw={TextFieldSizesRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TextFieldHiddenLabel.js" className="my-16" iframe={false} component={TextFieldHiddenLabelComponent} raw={TextFieldHiddenLabelRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Margin
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="LayoutTextFields.js" className="my-16" iframe={false} component={LayoutTextFieldsComponent} raw={LayoutTextFieldsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Full width
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FullWidthTextField.js" className="my-16" iframe={false} component={FullWidthTextFieldComponent} raw={FullWidthTextFieldRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="StateTextFields.js" className="my-16" iframe={false} component={StateTextFieldsComponent} raw={StateTextFieldsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Components
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ComposedTextField.js" className="my-16" iframe={false} component={ComposedTextFieldComponent} raw={ComposedTextFieldRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Inputs
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Inputs.js" className="my-16" iframe={false} component={InputsComponent} raw={InputsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Color
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ColorTextFields.js" className="my-16" iframe={false} component={ColorTextFieldsComponent} raw={ColorTextFieldsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedInputsStyled.js" className="my-16" iframe={false} component={CustomizedInputsStyledComponent} raw={CustomizedInputsStyledRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedInputsStyleOverrides.js" className="my-16" iframe={false} component={CustomizedInputsStyleOverridesComponent} raw={CustomizedInputsStyleOverridesRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedInputBase.js" className="my-16" iframe={false} component={CustomizedInputBaseComponent} raw={CustomizedInputBaseRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="UseFormControl.js" className="my-16" iframe={false} component={UseFormControlComponent} raw={UseFormControlRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Performance
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="HelperTextMisaligned.js" className="my-16" iframe={false} component={HelperTextMisalignedComponent} raw={HelperTextMisalignedRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				This can be fixed by passing a space character to the <code>helperText</code> prop:
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="HelperTextAligned.js" className="my-16" iframe={false} component={HelperTextAlignedComponent} raw={HelperTextAlignedRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FormattedInputs.js" className="my-16" iframe={false} component={FormattedInputsComponent} raw={FormattedInputsRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
