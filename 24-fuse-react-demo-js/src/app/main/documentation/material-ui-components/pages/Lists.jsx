...
import BasicListRaw from '../components/lists/BasicList.jsx?raw';
import NestedListComponent from '../components/lists/NestedList';
import NestedListRaw from '../components/lists/NestedList.jsx?raw';
import FolderListComponent from '../components/lists/FolderList';
import FolderListRaw from '../components/lists/FolderList.jsx?raw';
import InteractiveListComponent from '../components/lists/InteractiveList';
import InteractiveListRaw from '../components/lists/InteractiveList.jsx?raw';
import SelectedListItemComponent from '../components/lists/SelectedListItem';
import SelectedListItemRaw from '../components/lists/SelectedListItem.jsx?raw';
import AlignItemsListComponent from '../components/lists/AlignItemsList';
import AlignItemsListRaw from '../components/lists/AlignItemsList.jsx?raw';
import CheckboxListComponent from '../components/lists/CheckboxList';
import CheckboxListRaw from '../components/lists/CheckboxList.jsx?raw';
import CheckboxListSecondaryComponent from '../components/lists/CheckboxListSecondary';
import CheckboxListSecondaryRaw from '../components/lists/CheckboxListSecondary.jsx?raw';
import SwitchListSecondaryComponent from '../components/lists/SwitchListSecondary';
import SwitchListSecondaryRaw from '../components/lists/SwitchListSecondary.jsx?raw';
import PinnedSubheaderListComponent from '../components/lists/PinnedSubheaderList';
import PinnedSubheaderListRaw from '../components/lists/PinnedSubheaderList.jsx?raw';
import InsetListComponent from '../components/lists/InsetList';
import InsetListRaw from '../components/lists/InsetList.jsx?raw';
import GutterlessListComponent from '../components/lists/GutterlessList';
import GutterlessListRaw from '../components/lists/GutterlessList.jsx?raw';
import VirtualizedListComponent from '../components/lists/VirtualizedList';
import VirtualizedListRaw from '../components/lists/VirtualizedList.jsx?raw';
import CustomizedListComponent from '../components/lists/CustomizedList';
import CustomizedListRaw from '../components/lists/CustomizedList.jsx?raw';
function ListsDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/lists" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BasicList.js" className="my-16" iframe={false} component={BasicListComponent} raw={BasicListRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="NestedList.js" className="my-16" iframe={false} component={NestedListComponent} raw={NestedListRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Folder List
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FolderList.js" className="my-16" iframe={false} component={FolderListComponent} raw={FolderListRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Interactive
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="InteractiveList.js" className="my-16" iframe={false} component={InteractiveListComponent} raw={InteractiveListRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Selected ListItem
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SelectedListItem.js" className="my-16" iframe={false} component={SelectedListItemComponent} raw={SelectedListItemRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Align list items
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="AlignItemsList.js" className="my-16" iframe={false} component={AlignItemsListComponent} raw={AlignItemsListRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				List Controls
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CheckboxList.js" className="my-16" iframe={false} component={CheckboxListComponent} raw={CheckboxListRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				The checkbox is the secondary action for the list item and a separate target.
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CheckboxListSecondary.js" className="my-16" iframe={false} component={CheckboxListSecondaryComponent} raw={CheckboxListSecondaryRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Switch
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SwitchListSecondary.js" className="my-16" iframe={false} component={SwitchListSecondaryComponent} raw={SwitchListSecondaryRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Sticky subheader
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="PinnedSubheaderList.js" className="my-16" iframe={false} component={PinnedSubheaderListComponent} raw={PinnedSubheaderListRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Inset List Item
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="InsetList.js" className="my-16" iframe={false} component={InsetListComponent} raw={InsetListRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Gutterless list
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="GutterlessList.js" className="my-16" iframe={false} component={GutterlessListComponent} raw={GutterlessListRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Virtualized List
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="VirtualizedList.js" className="my-16" iframe={false} component={VirtualizedListComponent} raw={VirtualizedListRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedList.js" className="my-16" iframe={false} component={CustomizedListComponent} raw={CustomizedListRaw}/>
			</Typography>
		</>);
}
