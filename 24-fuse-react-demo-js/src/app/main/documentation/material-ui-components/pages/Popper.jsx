...
import SimplePopperRaw from '../components/popper/SimplePopper.jsx?raw';
import TransitionsPopperComponent from '../components/popper/TransitionsPopper';
import TransitionsPopperRaw from '../components/popper/TransitionsPopper.jsx?raw';
import SpringPopperComponent from '../components/popper/SpringPopper';
import SpringPopperRaw from '../components/popper/SpringPopper.jsx?raw';
import PositionedPopperComponent from '../components/popper/PositionedPopper';
import PositionedPopperRaw from '../components/popper/PositionedPopper.jsx?raw';
import VirtualElementPopperComponent from '../components/popper/VirtualElementPopper';
import VirtualElementPopperRaw from '../components/popper/VirtualElementPopper.jsx?raw';
import PopperPopupStateComponent from '../components/popper/PopperPopupState';
import PopperPopupStateRaw from '../components/popper/PopperPopupState.jsx?raw';
function PopperDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/popper" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SimplePopper.js" className="my-16" iframe={false} component={SimplePopperComponent} raw={SimplePopperRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Transitions
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TransitionsPopper.js" className="my-16" iframe={false} component={TransitionsPopperComponent} raw={TransitionsPopperRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				Alternatively, you can use <a href="https://github.com/pmndrs/react-spring">react-spring</a>.
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SpringPopper.js" className="my-16" iframe={false} component={SpringPopperComponent} raw={SpringPopperRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Positioned popper
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="PositionedPopper.js" className="my-16" iframe={false} component={PositionedPopperComponent} raw={PositionedPopperRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Scroll playground
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="VirtualElementPopper.js" className="my-16" iframe={false} component={VirtualElementPopperComponent} raw={VirtualElementPopperRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="PopperPopupState.js" className="my-16" iframe={false} component={PopperPopupStateComponent} raw={PopperPopupStateRaw}/>
			</Typography>
		</>);
}
