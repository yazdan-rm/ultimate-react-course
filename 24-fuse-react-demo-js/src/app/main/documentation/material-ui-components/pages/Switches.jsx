...
import BasicSwitchesRaw from '../components/switches/BasicSwitches.jsx?raw';
import SwitchLabelsComponent from '../components/switches/SwitchLabels';
import SwitchLabelsRaw from '../components/switches/SwitchLabels.jsx?raw';
import SwitchesSizeComponent from '../components/switches/SwitchesSize';
import SwitchesSizeRaw from '../components/switches/SwitchesSize.jsx?raw';
import ColorSwitchesComponent from '../components/switches/ColorSwitches';
import ColorSwitchesRaw from '../components/switches/ColorSwitches.jsx?raw';
import ControlledSwitchesComponent from '../components/switches/ControlledSwitches';
import ControlledSwitchesRaw from '../components/switches/ControlledSwitches.jsx?raw';
import SwitchesGroupComponent from '../components/switches/SwitchesGroup';
import SwitchesGroupRaw from '../components/switches/SwitchesGroup.jsx?raw';
import CustomizedSwitchesComponent from '../components/switches/CustomizedSwitches';
import CustomizedSwitchesRaw from '../components/switches/CustomizedSwitches.jsx?raw';
import FormControlLabelPositionComponent from '../components/switches/FormControlLabelPosition';
import FormControlLabelPositionRaw from '../components/switches/FormControlLabelPosition.jsx?raw';
function SwitchesDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/switches" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BasicSwitches.js" className="my-16" iframe={false} component={BasicSwitchesComponent} raw={BasicSwitchesRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Label
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SwitchLabels.js" className="my-16" iframe={false} component={SwitchLabelsComponent} raw={SwitchLabelsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Size
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SwitchesSize.js" className="my-16" iframe={false} component={SwitchesSizeComponent} raw={SwitchesSizeRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Color
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ColorSwitches.js" className="my-16" iframe={false} component={ColorSwitchesComponent} raw={ColorSwitchesRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Controlled
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ControlledSwitches.js" className="my-16" iframe={false} component={ControlledSwitchesComponent} raw={ControlledSwitchesRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SwitchesGroup.js" className="my-16" iframe={false} component={SwitchesGroupComponent} raw={SwitchesGroupRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedSwitches.js" className="my-16" iframe={false} component={CustomizedSwitchesComponent} raw={CustomizedSwitchesRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
