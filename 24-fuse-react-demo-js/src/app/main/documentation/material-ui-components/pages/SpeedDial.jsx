...
import BasicSpeedDialRaw from '../components/speed-dial/BasicSpeedDial.jsx?raw';
import PlaygroundSpeedDialComponent from '../components/speed-dial/PlaygroundSpeedDial';
import PlaygroundSpeedDialRaw from '../components/speed-dial/PlaygroundSpeedDial.jsx?raw';
import ControlledOpenSpeedDialComponent from '../components/speed-dial/ControlledOpenSpeedDial';
import ControlledOpenSpeedDialRaw from '../components/speed-dial/ControlledOpenSpeedDial.jsx?raw';
import OpenIconSpeedDialComponent from '../components/speed-dial/OpenIconSpeedDial';
import OpenIconSpeedDialRaw from '../components/speed-dial/OpenIconSpeedDial.jsx?raw';
import SpeedDialTooltipOpenComponent from '../components/speed-dial/SpeedDialTooltipOpen';
import SpeedDialTooltipOpenRaw from '../components/speed-dial/SpeedDialTooltipOpen.jsx?raw';
function SpeedDialDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/speed-dial" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BasicSpeedDial.js" className="my-16" iframe={false} component={BasicSpeedDialComponent} raw={BasicSpeedDialRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Playground
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="PlaygroundSpeedDial.js" className="my-16" iframe={false} component={PlaygroundSpeedDialComponent} raw={PlaygroundSpeedDialRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ControlledOpenSpeedDial.js" className="my-16" iframe={false} component={ControlledOpenSpeedDialComponent} raw={ControlledOpenSpeedDialRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Custom close icon
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="OpenIconSpeedDial.js" className="my-16" iframe={false} component={OpenIconSpeedDialComponent} raw={OpenIconSpeedDialRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SpeedDialTooltipOpen.js" className="my-16" iframe={false} component={SpeedDialTooltipOpenComponent} raw={SpeedDialTooltipOpenRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Accessibility
			</Typography>
