...
import BasicTableRaw from '../components/table/BasicTable.jsx?raw';
import DataTableComponent from '../components/table/DataTable';
import DataTableRaw from '../components/table/DataTable.jsx?raw';
import DenseTableComponent from '../components/table/DenseTable';
import DenseTableRaw from '../components/table/DenseTable.jsx?raw';
import EnhancedTableComponent from '../components/table/EnhancedTable';
import EnhancedTableRaw from '../components/table/EnhancedTable.jsx?raw';
import CustomizedTablesComponent from '../components/table/CustomizedTables';
import CustomizedTablesRaw from '../components/table/CustomizedTables.jsx?raw';
import CustomPaginationActionsTableComponent from '../components/table/CustomPaginationActionsTable';
import CustomPaginationActionsTableRaw from '../components/table/CustomPaginationActionsTable.jsx?raw';
import StickyHeadTableComponent from '../components/table/StickyHeadTable';
import StickyHeadTableRaw from '../components/table/StickyHeadTable.jsx?raw';
import ColumnGroupingTableComponent from '../components/table/ColumnGroupingTable';
import ColumnGroupingTableRaw from '../components/table/ColumnGroupingTable.jsx?raw';
import CollapsibleTableComponent from '../components/table/CollapsibleTable';
import CollapsibleTableRaw from '../components/table/CollapsibleTable.jsx?raw';
import SpanningTableComponent from '../components/table/SpanningTable';
import SpanningTableRaw from '../components/table/SpanningTable.jsx?raw';
import ReactVirtualizedTableComponent from '../components/table/ReactVirtualizedTable';
import ReactVirtualizedTableRaw from '../components/table/ReactVirtualizedTable.jsx?raw';
import AccessibleTableComponent from '../components/table/AccessibleTable';
import AccessibleTableRaw from '../components/table/AccessibleTable.jsx?raw';
function TableDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/table" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BasicTable.js" className="my-16" iframe={false} component={BasicTableComponent} raw={BasicTableRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Data table
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DataTable.js" className="my-16" iframe={false} component={DataTableComponent} raw={DataTableRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Dense table
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DenseTable.js" className="my-16" iframe={false} component={DenseTableComponent} raw={DenseTableRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Sorting &amp; selecting
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="EnhancedTable.js" className="my-16" iframe={false} component={EnhancedTableComponent} raw={EnhancedTableRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedTables.js" className="my-16" iframe={false} component={CustomizedTablesComponent} raw={CustomizedTablesRaw}/>
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomPaginationActionsTable.js" className="my-16" iframe={false} component={CustomPaginationActionsTableComponent} raw={CustomPaginationActionsTableRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Sticky header
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="StickyHeadTable.js" className="my-16" iframe={false} component={StickyHeadTableComponent} raw={StickyHeadTableRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Column grouping
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ColumnGroupingTable.js" className="my-16" iframe={false} component={ColumnGroupingTableComponent} raw={ColumnGroupingTableRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Collapsible table
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CollapsibleTable.js" className="my-16" iframe={false} component={CollapsibleTableComponent} raw={CollapsibleTableRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Spanning table
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SpanningTable.js" className="my-16" iframe={false} component={SpanningTableComponent} raw={SpanningTableRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Virtualized table
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ReactVirtualizedTable.js" className="my-16" iframe={false} component={ReactVirtualizedTableComponent} raw={ReactVirtualizedTableRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Accessibility
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="AccessibleTable.js" className="my-16" iframe={false} component={AccessibleTableComponent} raw={AccessibleTableRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Unstyled
			</Typography>
