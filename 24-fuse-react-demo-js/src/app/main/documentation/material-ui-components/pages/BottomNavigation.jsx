...
import SimpleBottomNavigationRaw from '../components/bottom-navigation/SimpleBottomNavigation.jsx?raw';
import LabelBottomNavigationComponent from '../components/bottom-navigation/LabelBottomNavigation';
import LabelBottomNavigationRaw from '../components/bottom-navigation/LabelBottomNavigation.jsx?raw';
import FixedBottomNavigationComponent from '../components/bottom-navigation/FixedBottomNavigation';
import FixedBottomNavigationRaw from '../components/bottom-navigation/FixedBottomNavigation.jsx?raw';
function BottomNavigationDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/bottom-navigation" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SimpleBottomNavigation.js" className="my-16" iframe={false} component={SimpleBottomNavigationComponent} raw={SimpleBottomNavigationRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="LabelBottomNavigation.js" className="my-16" iframe={false} component={LabelBottomNavigationComponent} raw={LabelBottomNavigationRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Fixed positioning
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FixedBottomNavigation.js" className="my-16" iframe component={FixedBottomNavigationComponent} raw={FixedBottomNavigationRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
