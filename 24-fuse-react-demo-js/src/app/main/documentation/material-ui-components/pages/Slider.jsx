...
import ContinuousSliderRaw from '../components/slider/ContinuousSlider.jsx?raw';
import SliderSizesComponent from '../components/slider/SliderSizes';
import SliderSizesRaw from '../components/slider/SliderSizes.jsx?raw';
import DiscreteSliderComponent from '../components/slider/DiscreteSlider';
import DiscreteSliderRaw from '../components/slider/DiscreteSlider.jsx?raw';
import DiscreteSliderStepsComponent from '../components/slider/DiscreteSliderSteps';
import DiscreteSliderStepsRaw from '../components/slider/DiscreteSliderSteps.jsx?raw';
import DiscreteSliderMarksComponent from '../components/slider/DiscreteSliderMarks';
import DiscreteSliderMarksRaw from '../components/slider/DiscreteSliderMarks.jsx?raw';
import DiscreteSliderValuesComponent from '../components/slider/DiscreteSliderValues';
import DiscreteSliderValuesRaw from '../components/slider/DiscreteSliderValues.jsx?raw';
import DiscreteSliderLabelComponent from '../components/slider/DiscreteSliderLabel';
import DiscreteSliderLabelRaw from '../components/slider/DiscreteSliderLabel.jsx?raw';
import RangeSliderComponent from '../components/slider/RangeSlider';
import RangeSliderRaw from '../components/slider/RangeSlider.jsx?raw';
import MinimumDistanceSliderComponent from '../components/slider/MinimumDistanceSlider';
import MinimumDistanceSliderRaw from '../components/slider/MinimumDistanceSlider.jsx?raw';
import InputSliderComponent from '../components/slider/InputSlider';
import InputSliderRaw from '../components/slider/InputSlider.jsx?raw';
import ColorSliderComponent from '../components/slider/ColorSlider';
import ColorSliderRaw from '../components/slider/ColorSlider.jsx?raw';
import CustomizedSliderComponent from '../components/slider/CustomizedSlider';
import CustomizedSliderRaw from '../components/slider/CustomizedSlider.jsx?raw';
import MusicPlayerSliderComponent from '../components/slider/MusicPlayerSlider';
import MusicPlayerSliderRaw from '../components/slider/MusicPlayerSlider.jsx?raw';
import VerticalSliderComponent from '../components/slider/VerticalSlider';
import VerticalSliderRaw from '../components/slider/VerticalSlider.jsx?raw';
import VerticalAccessibleSliderComponent from '../components/slider/VerticalAccessibleSlider';
import VerticalAccessibleSliderRaw from '../components/slider/VerticalAccessibleSlider.jsx?raw';
import CustomMarksComponent from '../components/slider/CustomMarks';
import CustomMarksRaw from '../components/slider/CustomMarks.jsx?raw';
import TrackFalseSliderComponent from '../components/slider/TrackFalseSlider';
import TrackFalseSliderRaw from '../components/slider/TrackFalseSlider.jsx?raw';
import TrackInvertedSliderComponent from '../components/slider/TrackInvertedSlider';
import TrackInvertedSliderRaw from '../components/slider/TrackInvertedSlider.jsx?raw';
import NonLinearSliderComponent from '../components/slider/NonLinearSlider';
import NonLinearSliderRaw from '../components/slider/NonLinearSlider.jsx?raw';
function SliderDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/slider" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ContinuousSlider.js" className="my-16" iframe={false} component={ContinuousSliderComponent} raw={ContinuousSliderRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Sizes
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SliderSizes.js" className="my-16" iframe={false} component={SliderSizesComponent} raw={SliderSizesRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Discrete sliders
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DiscreteSlider.js" className="my-16" iframe={false} component={DiscreteSliderComponent} raw={DiscreteSliderRaw}/>
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DiscreteSliderSteps.js" className="my-16" iframe={false} component={DiscreteSliderStepsComponent} raw={DiscreteSliderStepsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Custom marks
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DiscreteSliderMarks.js" className="my-16" iframe={false} component={DiscreteSliderMarksComponent} raw={DiscreteSliderMarksRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Restricted values
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DiscreteSliderValues.js" className="my-16" iframe={false} component={DiscreteSliderValuesComponent} raw={DiscreteSliderValuesRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DiscreteSliderLabel.js" className="my-16" iframe={false} component={DiscreteSliderLabelComponent} raw={DiscreteSliderLabelRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Range slider
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="RangeSlider.js" className="my-16" iframe={false} component={RangeSliderComponent} raw={RangeSliderRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Minimum distance
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="MinimumDistanceSlider.js" className="my-16" iframe={false} component={MinimumDistanceSliderComponent} raw={MinimumDistanceSliderRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="InputSlider.js" className="my-16" iframe={false} component={InputSliderComponent} raw={InputSliderRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Color
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ColorSlider.js" className="my-16" iframe={false} component={ColorSliderComponent} raw={ColorSliderRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedSlider.js" className="my-16" iframe={false} component={CustomizedSliderComponent} raw={CustomizedSliderRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Music player
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="MusicPlayerSlider.js" className="my-16" iframe={false} component={MusicPlayerSliderComponent} raw={MusicPlayerSliderRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Vertical sliders
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="VerticalSlider.js" className="my-16" iframe={false} component={VerticalSliderComponent} raw={VerticalSliderRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="VerticalAccessibleSlider.js" className="my-16" iframe={false} component={VerticalAccessibleSliderComponent} raw={VerticalAccessibleSliderRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Marks placement
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomMarks.js" className="my-16" iframe={false} component={CustomMarksComponent} raw={CustomMarksRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Track
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TrackFalseSlider.js" className="my-16" iframe={false} component={TrackFalseSliderComponent} raw={TrackFalseSliderRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Inverted track
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TrackInvertedSlider.js" className="my-16" iframe={false} component={TrackInvertedSliderComponent} raw={TrackInvertedSliderRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Non-linear scale
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="NonLinearSlider.js" className="my-16" iframe={false} component={NonLinearSliderComponent} raw={NonLinearSliderRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Accessibility
			</Typography>
