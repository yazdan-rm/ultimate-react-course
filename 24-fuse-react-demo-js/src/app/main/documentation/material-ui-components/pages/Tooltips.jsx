...
import BasicTooltipRaw from '../components/tooltips/BasicTooltip.jsx?raw';
import PositionedTooltipsComponent from '../components/tooltips/PositionedTooltips';
import PositionedTooltipsRaw from '../components/tooltips/PositionedTooltips.jsx?raw';
import CustomizedTooltipsComponent from '../components/tooltips/CustomizedTooltips';
import CustomizedTooltipsRaw from '../components/tooltips/CustomizedTooltips.jsx?raw';
import ArrowTooltipsComponent from '../components/tooltips/ArrowTooltips';
import ArrowTooltipsRaw from '../components/tooltips/ArrowTooltips.jsx?raw';
import TooltipOffsetComponent from '../components/tooltips/TooltipOffset';
import TooltipOffsetRaw from '../components/tooltips/TooltipOffset.jsx?raw';
import TooltipMarginComponent from '../components/tooltips/TooltipMargin';
import TooltipMarginRaw from '../components/tooltips/TooltipMargin.jsx?raw';
import TriggersTooltipsComponent from '../components/tooltips/TriggersTooltips';
import TriggersTooltipsRaw from '../components/tooltips/TriggersTooltips.jsx?raw';
import ControlledTooltipsComponent from '../components/tooltips/ControlledTooltips';
import ControlledTooltipsRaw from '../components/tooltips/ControlledTooltips.jsx?raw';
import VariableWidthComponent from '../components/tooltips/VariableWidth';
import VariableWidthRaw from '../components/tooltips/VariableWidth.jsx?raw';
import NonInteractiveTooltipsComponent from '../components/tooltips/NonInteractiveTooltips';
import NonInteractiveTooltipsRaw from '../components/tooltips/NonInteractiveTooltips.jsx?raw';
import DisabledTooltipsComponent from '../components/tooltips/DisabledTooltips';
import DisabledTooltipsRaw from '../components/tooltips/DisabledTooltips.jsx?raw';
import TransitionsTooltipsComponent from '../components/tooltips/TransitionsTooltips';
import TransitionsTooltipsRaw from '../components/tooltips/TransitionsTooltips.jsx?raw';
import FollowCursorTooltipsComponent from '../components/tooltips/FollowCursorTooltips';
import FollowCursorTooltipsRaw from '../components/tooltips/FollowCursorTooltips.jsx?raw';
import AnchorElTooltipsComponent from '../components/tooltips/AnchorElTooltips';
import AnchorElTooltipsRaw from '../components/tooltips/AnchorElTooltips.jsx?raw';
import DelayTooltipsComponent from '../components/tooltips/DelayTooltips';
import DelayTooltipsRaw from '../components/tooltips/DelayTooltips.jsx?raw';
import AccessibilityTooltipsComponent from '../components/tooltips/AccessibilityTooltips';
import AccessibilityTooltipsRaw from '../components/tooltips/AccessibilityTooltips.jsx?raw';
function TooltipsDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/tooltips" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BasicTooltip.js" className="my-16" iframe={false} component={BasicTooltipComponent} raw={BasicTooltipRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Positioned tooltips
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="PositionedTooltips.js" className="my-16" iframe={false} component={PositionedTooltipsComponent} raw={PositionedTooltipsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedTooltips.js" className="my-16" iframe={false} component={CustomizedTooltipsComponent} raw={CustomizedTooltipsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Arrow tooltips
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ArrowTooltips.js" className="my-16" iframe={false} component={ArrowTooltipsComponent} raw={ArrowTooltipsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TooltipOffset.js" className="my-16" iframe={false} component={TooltipOffsetComponent} raw={TooltipOffsetRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				Alternatively, you can use the <code>slotProps</code> prop to customize the margin of the popper.
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TooltipMargin.js" className="my-16" iframe={false} component={TooltipMarginComponent} raw={TooltipMarginRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TriggersTooltips.js" className="my-16" iframe={false} component={TriggersTooltipsComponent} raw={TriggersTooltipsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Controlled tooltips
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ControlledTooltips.js" className="my-16" iframe={false} component={ControlledTooltipsComponent} raw={ControlledTooltipsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Variable width
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="VariableWidth.js" className="my-16" iframe={false} component={VariableWidthComponent} raw={VariableWidthRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Interactive
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="NonInteractiveTooltips.js" className="my-16" iframe={false} component={NonInteractiveTooltipsComponent} raw={NonInteractiveTooltipsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Disabled elements
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DisabledTooltips.js" className="my-16" iframe={false} component={DisabledTooltipsComponent} raw={DisabledTooltipsRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TransitionsTooltips.js" className="my-16" iframe={false} component={TransitionsTooltipsComponent} raw={TransitionsTooltipsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Follow cursor
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FollowCursorTooltips.js" className="my-16" iframe={false} component={FollowCursorTooltipsComponent} raw={FollowCursorTooltipsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Virtual element
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="AnchorElTooltips.js" className="my-16" iframe={false} component={AnchorElTooltipsComponent} raw={AnchorElTooltipsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Showing and hiding
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DelayTooltips.js" className="my-16" iframe={false} component={DelayTooltipsComponent} raw={DelayTooltipsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Accessibility
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="AccessibilityTooltips.js" className="my-16" iframe={false} component={AccessibilityTooltipsComponent} raw={AccessibilityTooltipsRaw}/>
			</Typography>
		</>);
}
