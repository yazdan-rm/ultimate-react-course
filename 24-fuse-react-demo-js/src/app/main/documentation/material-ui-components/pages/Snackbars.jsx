...
import SimpleSnackbarRaw from '../components/snackbars/SimpleSnackbar.jsx?raw';
import PositionedSnackbarComponent from '../components/snackbars/PositionedSnackbar';
import PositionedSnackbarRaw from '../components/snackbars/PositionedSnackbar.jsx?raw';
import LongTextSnackbarComponent from '../components/snackbars/LongTextSnackbar';
import LongTextSnackbarRaw from '../components/snackbars/LongTextSnackbar.jsx?raw';
import AutohideSnackbarComponent from '../components/snackbars/AutohideSnackbar';
import AutohideSnackbarRaw from '../components/snackbars/AutohideSnackbar.jsx?raw';
import TransitionsSnackbarComponent from '../components/snackbars/TransitionsSnackbar';
import TransitionsSnackbarRaw from '../components/snackbars/TransitionsSnackbar.jsx?raw';
import CustomizedSnackbarsComponent from '../components/snackbars/CustomizedSnackbars';
import CustomizedSnackbarsRaw from '../components/snackbars/CustomizedSnackbars.jsx?raw';
import FabIntegrationSnackbarComponent from '../components/snackbars/FabIntegrationSnackbar';
import FabIntegrationSnackbarRaw from '../components/snackbars/FabIntegrationSnackbar.jsx?raw';
import ConsecutiveSnackbarsComponent from '../components/snackbars/ConsecutiveSnackbars';
import ConsecutiveSnackbarsRaw from '../components/snackbars/ConsecutiveSnackbars.jsx?raw';
import IntegrationNotistackComponent from '../components/snackbars/IntegrationNotistack';
import IntegrationNotistackRaw from '../components/snackbars/IntegrationNotistack.jsx?raw';
function SnackbarsDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/snackbars" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SimpleSnackbar.js" className="my-16" iframe={false} component={SimpleSnackbarComponent} raw={SimpleSnackbarRaw}/>
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="PositionedSnackbar.js" className="my-16" iframe={false} component={PositionedSnackbarComponent} raw={PositionedSnackbarRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Content
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="LongTextSnackbar.js" className="my-16" iframe={false} component={LongTextSnackbarComponent} raw={LongTextSnackbarRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Automatic dismiss
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="AutohideSnackbar.js" className="my-16" iframe={false} component={AutohideSnackbarComponent} raw={AutohideSnackbarRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Transitions
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TransitionsSnackbar.js" className="my-16" iframe={false} component={TransitionsSnackbarComponent} raw={TransitionsSnackbarRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedSnackbars.js" className="my-16" iframe={false} component={CustomizedSnackbarsComponent} raw={CustomizedSnackbarsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FabIntegrationSnackbar.js" className="my-16" iframe component={FabIntegrationSnackbarComponent} raw={FabIntegrationSnackbarRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Common examples
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ConsecutiveSnackbars.js" className="my-16" iframe={false} component={ConsecutiveSnackbarsComponent} raw={ConsecutiveSnackbarsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<img src="https://img.shields.io/github/stars/iamhosseindhv/notistack.svg?style=social&label=Star" alt="stars"/>
				<img src="https://img.shields.io/npm/dm/notistack.svg" alt="npm downloads"/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="IntegrationNotistack.js" className="my-16" iframe={false} component={IntegrationNotistackComponent} raw={IntegrationNotistackRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
