...
import RadioButtonsGroupRaw from '../components/radio-buttons/RadioButtonsGroup.jsx?raw';
import RowRadioButtonsGroupComponent from '../components/radio-buttons/RowRadioButtonsGroup';
import RowRadioButtonsGroupRaw from '../components/radio-buttons/RowRadioButtonsGroup.jsx?raw';
import ControlledRadioButtonsGroupComponent from '../components/radio-buttons/ControlledRadioButtonsGroup';
import ControlledRadioButtonsGroupRaw from '../components/radio-buttons/ControlledRadioButtonsGroup.jsx?raw';
import RadioButtonsComponent from '../components/radio-buttons/RadioButtons';
import RadioButtonsRaw from '../components/radio-buttons/RadioButtons.jsx?raw';
import SizeRadioButtonsComponent from '../components/radio-buttons/SizeRadioButtons';
import SizeRadioButtonsRaw from '../components/radio-buttons/SizeRadioButtons.jsx?raw';
import ColorRadioButtonsComponent from '../components/radio-buttons/ColorRadioButtons';
import ColorRadioButtonsRaw from '../components/radio-buttons/ColorRadioButtons.jsx?raw';
import FormControlLabelPlacementComponent from '../components/radio-buttons/FormControlLabelPlacement';
import FormControlLabelPlacementRaw from '../components/radio-buttons/FormControlLabelPlacement.jsx?raw';
import ErrorRadiosComponent from '../components/radio-buttons/ErrorRadios';
import ErrorRadiosRaw from '../components/radio-buttons/ErrorRadios.jsx?raw';
import CustomizedRadiosComponent from '../components/radio-buttons/CustomizedRadios';
import CustomizedRadiosRaw from '../components/radio-buttons/CustomizedRadios.jsx?raw';
import UseRadioGroupComponent from '../components/radio-buttons/UseRadioGroup';
import UseRadioGroupRaw from '../components/radio-buttons/UseRadioGroup.jsx?raw';
function RadioButtonsDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/radio-buttons" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="RadioButtonsGroup.js" className="my-16" iframe={false} component={RadioButtonsGroupComponent} raw={RadioButtonsGroupRaw}/>
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="RowRadioButtonsGroup.js" className="my-16" iframe={false} component={RowRadioButtonsGroupComponent} raw={RowRadioButtonsGroupRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Controlled
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ControlledRadioButtonsGroup.js" className="my-16" iframe={false} component={ControlledRadioButtonsGroupComponent} raw={ControlledRadioButtonsGroupRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="RadioButtons.js" className="my-16" iframe={false} component={RadioButtonsComponent} raw={RadioButtonsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Size
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SizeRadioButtons.js" className="my-16" iframe={false} component={SizeRadioButtonsComponent} raw={SizeRadioButtonsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Color
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ColorRadioButtons.js" className="my-16" iframe={false} component={ColorRadioButtonsComponent} raw={ColorRadioButtonsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Label placement
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FormControlLabelPlacement.js" className="my-16" iframe={false} component={FormControlLabelPlacementComponent} raw={FormControlLabelPlacementRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Show error
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ErrorRadios.js" className="my-16" iframe={false} component={ErrorRadiosComponent} raw={ErrorRadiosRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedRadios.js" className="my-16" iframe={false} component={CustomizedRadiosComponent} raw={CustomizedRadiosRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="UseRadioGroup.js" className="my-16" iframe={false} component={UseRadioGroupComponent} raw={UseRadioGroupRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				When to use
			</Typography>
