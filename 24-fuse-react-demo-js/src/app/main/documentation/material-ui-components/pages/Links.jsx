...
import LinksRaw from '../components/links/Links.jsx?raw';
import UnderlineLinkComponent from '../components/links/UnderlineLink';
import UnderlineLinkRaw from '../components/links/UnderlineLink.jsx?raw';
import ButtonLinkComponent from '../components/links/ButtonLink';
import ButtonLinkRaw from '../components/links/ButtonLink.jsx?raw';
function LinksDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/links" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Links.js" className="my-16" iframe={false} component={LinksComponent} raw={LinksRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="UnderlineLink.js" className="my-16" iframe={false} component={UnderlineLinkComponent} raw={UnderlineLinkRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Security
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ButtonLink.js" className="my-16" iframe={false} component={ButtonLinkComponent} raw={ButtonLinkRaw}/>
			</Typography>
