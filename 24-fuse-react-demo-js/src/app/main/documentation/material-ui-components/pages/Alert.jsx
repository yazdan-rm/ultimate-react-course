...
import SimpleAlertRaw from '../components/alert/SimpleAlert.jsx?raw';
import BasicAlertsComponent from '../components/alert/BasicAlerts';
import BasicAlertsRaw from '../components/alert/BasicAlerts.jsx?raw';
import FilledAlertsComponent from '../components/alert/FilledAlerts';
import FilledAlertsRaw from '../components/alert/FilledAlerts.jsx?raw';
import OutlinedAlertsComponent from '../components/alert/OutlinedAlerts';
import OutlinedAlertsRaw from '../components/alert/OutlinedAlerts.jsx?raw';
import ColorAlertsComponent from '../components/alert/ColorAlerts';
import ColorAlertsRaw from '../components/alert/ColorAlerts.jsx?raw';
import ActionAlertsComponent from '../components/alert/ActionAlerts';
import ActionAlertsRaw from '../components/alert/ActionAlerts.jsx?raw';
import IconAlertsComponent from '../components/alert/IconAlerts';
import IconAlertsRaw from '../components/alert/IconAlerts.jsx?raw';
import DescriptionAlertsComponent from '../components/alert/DescriptionAlerts';
import DescriptionAlertsRaw from '../components/alert/DescriptionAlerts.jsx?raw';
import TransitionAlertsComponent from '../components/alert/TransitionAlerts';
import TransitionAlertsRaw from '../components/alert/TransitionAlerts.jsx?raw';
function AlertDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/alert" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SimpleAlert.js" className="my-16" iframe={false} component={SimpleAlertComponent} raw={SimpleAlertRaw}/>
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BasicAlerts.js" className="my-16" iframe={false} component={BasicAlertsComponent} raw={BasicAlertsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Variants
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FilledAlerts.js" className="my-16" iframe={false} component={FilledAlertsComponent} raw={FilledAlertsRaw}/>
			</Typography>
			<Typography className="text-14 mt-12 mb-10" component="h4">
				Outlined
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="OutlinedAlerts.js" className="my-16" iframe={false} component={OutlinedAlertsComponent} raw={OutlinedAlertsRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ColorAlerts.js" className="my-16" iframe={false} component={ColorAlertsComponent} raw={ColorAlertsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Actions
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ActionAlerts.js" className="my-16" iframe={false} component={ActionAlertsComponent} raw={ActionAlertsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Icons
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="IconAlerts.js" className="my-16" iframe={false} component={IconAlertsComponent} raw={IconAlertsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DescriptionAlerts.js" className="my-16" iframe={false} component={DescriptionAlertsComponent} raw={DescriptionAlertsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Transitions
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TransitionAlerts.js" className="my-16" iframe={false} component={TransitionAlertsComponent} raw={TransitionAlertsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Accessibility
			</Typography>
