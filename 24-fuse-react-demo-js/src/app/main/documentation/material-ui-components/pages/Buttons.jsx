...
import BasicButtonsRaw from '../components/buttons/BasicButtons.jsx?raw';
import TextButtonsComponent from '../components/buttons/TextButtons';
import TextButtonsRaw from '../components/buttons/TextButtons.jsx?raw';
import ContainedButtonsComponent from '../components/buttons/ContainedButtons';
import ContainedButtonsRaw from '../components/buttons/ContainedButtons.jsx?raw';
import DisableElevationComponent from '../components/buttons/DisableElevation';
import DisableElevationRaw from '../components/buttons/DisableElevation.jsx?raw';
import OutlinedButtonsComponent from '../components/buttons/OutlinedButtons';
import OutlinedButtonsRaw from '../components/buttons/OutlinedButtons.jsx?raw';
import ColorButtonsComponent from '../components/buttons/ColorButtons';
import ColorButtonsRaw from '../components/buttons/ColorButtons.jsx?raw';
import ButtonSizesComponent from '../components/buttons/ButtonSizes';
import ButtonSizesRaw from '../components/buttons/ButtonSizes.jsx?raw';
import IconLabelButtonsComponent from '../components/buttons/IconLabelButtons';
import IconLabelButtonsRaw from '../components/buttons/IconLabelButtons.jsx?raw';
import IconButtonsComponent from '../components/buttons/IconButtons';
import IconButtonsRaw from '../components/buttons/IconButtons.jsx?raw';
import IconButtonSizesComponent from '../components/buttons/IconButtonSizes';
import IconButtonSizesRaw from '../components/buttons/IconButtonSizes.jsx?raw';
import IconButtonColorsComponent from '../components/buttons/IconButtonColors';
import IconButtonColorsRaw from '../components/buttons/IconButtonColors.jsx?raw';
import InputFileUploadComponent from '../components/buttons/InputFileUpload';
import InputFileUploadRaw from '../components/buttons/InputFileUpload.jsx?raw';
import CustomizedButtonsComponent from '../components/buttons/CustomizedButtons';
import CustomizedButtonsRaw from '../components/buttons/CustomizedButtons.jsx?raw';
import ButtonBaseDemoComponent from '../components/buttons/ButtonBaseDemo';
import ButtonBaseDemoRaw from '../components/buttons/ButtonBaseDemo.jsx?raw';
function ButtonsDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/buttons" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BasicButtons.js" className="my-16" iframe={false} component={BasicButtonsComponent} raw={BasicButtonsRaw}/>
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TextButtons.js" className="my-16" iframe={false} component={TextButtonsComponent} raw={TextButtonsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Contained button
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ContainedButtons.js" className="my-16" iframe={false} component={ContainedButtonsComponent} raw={ContainedButtonsRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				You can remove the elevation with the <code>disableElevation</code> prop.
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DisableElevation.js" className="my-16" iframe={false} component={DisableElevationComponent} raw={DisableElevationRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Outlined button
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="OutlinedButtons.js" className="my-16" iframe={false} component={OutlinedButtonsComponent} raw={OutlinedButtonsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Handling clicks
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ColorButtons.js" className="my-16" iframe={false} component={ColorButtonsComponent} raw={ColorButtonsRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ButtonSizes.js" className="my-16" iframe={false} component={ButtonSizesComponent} raw={ButtonSizesRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="IconLabelButtons.js" className="my-16" iframe={false} component={IconLabelButtonsComponent} raw={IconLabelButtonsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Icon button
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="IconButtons.js" className="my-16" iframe={false} component={IconButtonsComponent} raw={IconButtonsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Sizes
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="IconButtonSizes.js" className="my-16" iframe={false} component={IconButtonSizesComponent} raw={IconButtonSizesRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Colors
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="IconButtonColors.js" className="my-16" iframe={false} component={IconButtonColorsComponent} raw={IconButtonColorsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				File upload
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="InputFileUpload.js" className="my-16" iframe={false} component={InputFileUploadComponent} raw={InputFileUploadRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedButtons.js" className="my-16" iframe={false} component={CustomizedButtonsComponent} raw={CustomizedButtonsRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ButtonBaseDemo.js" className="my-16" iframe={false} component={ButtonBaseDemoComponent} raw={ButtonBaseDemoRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
