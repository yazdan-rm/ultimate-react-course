...
import SimpleDialogDemoRaw from '../components/dialogs/SimpleDialogDemo.jsx?raw';
import AlertDialogComponent from '../components/dialogs/AlertDialog';
import AlertDialogRaw from '../components/dialogs/AlertDialog.jsx?raw';
import AlertDialogSlideComponent from '../components/dialogs/AlertDialogSlide';
import AlertDialogSlideRaw from '../components/dialogs/AlertDialogSlide.jsx?raw';
import FormDialogComponent from '../components/dialogs/FormDialog';
import FormDialogRaw from '../components/dialogs/FormDialog.jsx?raw';
import CustomizedDialogsComponent from '../components/dialogs/CustomizedDialogs';
import CustomizedDialogsRaw from '../components/dialogs/CustomizedDialogs.jsx?raw';
import FullScreenDialogComponent from '../components/dialogs/FullScreenDialog';
import FullScreenDialogRaw from '../components/dialogs/FullScreenDialog.jsx?raw';
import MaxWidthDialogComponent from '../components/dialogs/MaxWidthDialog';
import MaxWidthDialogRaw from '../components/dialogs/MaxWidthDialog.jsx?raw';
import ResponsiveDialogComponent from '../components/dialogs/ResponsiveDialog';
import ResponsiveDialogRaw from '../components/dialogs/ResponsiveDialog.jsx?raw';
import ConfirmationDialogComponent from '../components/dialogs/ConfirmationDialog';
import ConfirmationDialogRaw from '../components/dialogs/ConfirmationDialog.jsx?raw';
import CookiesBannerComponent from '../components/dialogs/CookiesBanner';
import CookiesBannerRaw from '../components/dialogs/CookiesBanner.jsx?raw';
import DraggableDialogComponent from '../components/dialogs/DraggableDialog';
import DraggableDialogRaw from '../components/dialogs/DraggableDialog.jsx?raw';
import ScrollDialogComponent from '../components/dialogs/ScrollDialog';
import ScrollDialogRaw from '../components/dialogs/ScrollDialog.jsx?raw';
function DialogsDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/dialogs" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SimpleDialogDemo.js" className="my-16" iframe={false} component={SimpleDialogDemoComponent} raw={SimpleDialogDemoRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Basics
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="AlertDialog.js" className="my-16" iframe={false} component={AlertDialogComponent} raw={AlertDialogRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Transitions
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="AlertDialogSlide.js" className="my-16" iframe={false} component={AlertDialogSlideComponent} raw={AlertDialogSlideRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Form dialogs
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FormDialog.js" className="my-16" iframe={false} component={FormDialogComponent} raw={FormDialogRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedDialogs.js" className="my-16" iframe={false} component={CustomizedDialogsComponent} raw={CustomizedDialogsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Full-screen dialogs
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FullScreenDialog.js" className="my-16" iframe={false} component={FullScreenDialogComponent} raw={FullScreenDialogRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Optional sizes
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="MaxWidthDialog.js" className="my-16" iframe={false} component={MaxWidthDialogComponent} raw={MaxWidthDialogRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ResponsiveDialog.js" className="my-16" iframe={false} component={ResponsiveDialogComponent} raw={ResponsiveDialogRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ConfirmationDialog.js" className="my-16" iframe={false} component={ConfirmationDialogComponent} raw={ConfirmationDialogRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Non-modal dialog
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CookiesBanner.js" className="my-16" iframe component={CookiesBannerComponent} raw={CookiesBannerRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Draggable dialog
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DraggableDialog.js" className="my-16" iframe={false} component={DraggableDialogComponent} raw={DraggableDialogRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ScrollDialog.js" className="my-16" iframe={false} component={ScrollDialogComponent} raw={ScrollDialogRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Performance
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<img src="https://img.shields.io/github/stars/jonatanklosko/material-ui-confirm?style=social&label=Star" alt="stars"/>
