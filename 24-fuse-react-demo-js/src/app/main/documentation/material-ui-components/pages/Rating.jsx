...
import BasicRatingRaw from '../components/rating/BasicRating.jsx?raw';
import HalfRatingComponent from '../components/rating/HalfRating';
import HalfRatingRaw from '../components/rating/HalfRating.jsx?raw';
import HoverRatingComponent from '../components/rating/HoverRating';
import HoverRatingRaw from '../components/rating/HoverRating.jsx?raw';
import RatingSizeComponent from '../components/rating/RatingSize';
import RatingSizeRaw from '../components/rating/RatingSize.jsx?raw';
import CustomizedRatingComponent from '../components/rating/CustomizedRating';
import CustomizedRatingRaw from '../components/rating/CustomizedRating.jsx?raw';
import RadioGroupRatingComponent from '../components/rating/RadioGroupRating';
import RadioGroupRatingRaw from '../components/rating/RadioGroupRating.jsx?raw';
import TextRatingComponent from '../components/rating/TextRating';
import TextRatingRaw from '../components/rating/TextRating.jsx?raw';
function RatingDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/rating" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BasicRating.js" className="my-16" iframe={false} component={BasicRatingComponent} raw={BasicRatingRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Rating precision
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="HalfRating.js" className="my-16" iframe={false} component={HalfRatingComponent} raw={HalfRatingRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Hover feedback
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="HoverRating.js" className="my-16" iframe={false} component={HoverRatingComponent} raw={HoverRatingRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Sizes
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="RatingSize.js" className="my-16" iframe={false} component={RatingSizeComponent} raw={RatingSizeRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedRating.js" className="my-16" iframe={false} component={CustomizedRatingComponent} raw={CustomizedRatingRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Radio group
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="RadioGroupRating.js" className="my-16" iframe={false} component={RadioGroupRatingComponent} raw={RadioGroupRatingRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Accessibility
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TextRating.js" className="my-16" iframe={false} component={TextRatingComponent} raw={TextRatingRaw}/>
			</Typography>
