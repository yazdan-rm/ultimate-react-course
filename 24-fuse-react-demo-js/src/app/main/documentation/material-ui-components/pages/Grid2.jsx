...
import BasicGridRaw from '../components/grid2/BasicGrid.jsx?raw';
import FullWidthGridComponent from '../components/grid2/FullWidthGrid';
import FullWidthGridRaw from '../components/grid2/FullWidthGrid.jsx?raw';
import SpacingGridComponent from '../components/grid2/SpacingGrid';
import SpacingGridRaw from '../components/grid2/SpacingGrid.jsx?raw';
import RowAndColumnSpacingComponent from '../components/grid2/RowAndColumnSpacing';
import RowAndColumnSpacingRaw from '../components/grid2/RowAndColumnSpacing.jsx?raw';
import ResponsiveGridComponent from '../components/grid2/ResponsiveGrid';
import ResponsiveGridRaw from '../components/grid2/ResponsiveGrid.jsx?raw';
import AutoGridComponent from '../components/grid2/AutoGrid';
import AutoGridRaw from '../components/grid2/AutoGrid.jsx?raw';
import VariableWidthGridComponent from '../components/grid2/VariableWidthGrid';
import VariableWidthGridRaw from '../components/grid2/VariableWidthGrid.jsx?raw';
import NestedGridComponent from '../components/grid2/NestedGrid';
import NestedGridRaw from '../components/grid2/NestedGrid.jsx?raw';
import NestedGridColumnsComponent from '../components/grid2/NestedGridColumns';
import NestedGridColumnsRaw from '../components/grid2/NestedGridColumns.jsx?raw';
import ColumnsGridComponent from '../components/grid2/ColumnsGrid';
import ColumnsGridRaw from '../components/grid2/ColumnsGrid.jsx?raw';
import OffsetGridComponent from '../components/grid2/OffsetGrid';
import OffsetGridRaw from '../components/grid2/OffsetGrid.jsx?raw';
import OverflowGridComponent from '../components/grid2/OverflowGrid';
import OverflowGridRaw from '../components/grid2/OverflowGrid.jsx?raw';
import CenteredElementGridComponent from '../components/grid2/CenteredElementGrid';
import CenteredElementGridRaw from '../components/grid2/CenteredElementGrid.jsx?raw';
import FullBorderedGridComponent from '../components/grid2/FullBorderedGrid';
import FullBorderedGridRaw from '../components/grid2/FullBorderedGrid.jsx?raw';
import HalfBorderedGridComponent from '../components/grid2/HalfBorderedGrid';
import HalfBorderedGridRaw from '../components/grid2/HalfBorderedGrid.jsx?raw';
function Grid2Doc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/grid2" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BasicGrid.js" className="my-16" iframe={false} component={BasicGridComponent} raw={BasicGridRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FullWidthGrid.js" className="my-16" iframe={false} component={FullWidthGridComponent} raw={FullWidthGridRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Spacing
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SpacingGrid.js" className="my-16" iframe={false} component={SpacingGridComponent} raw={SpacingGridRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="RowAndColumnSpacing.js" className="my-16" iframe={false} component={RowAndColumnSpacingComponent} raw={RowAndColumnSpacingRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Responsive values
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ResponsiveGrid.js" className="my-16" iframe={false} component={ResponsiveGridComponent} raw={ResponsiveGridRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="AutoGrid.js" className="my-16" iframe={false} component={AutoGridComponent} raw={AutoGridRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="VariableWidthGrid.js" className="my-16" iframe={false} component={VariableWidthGridComponent} raw={VariableWidthGridRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Nested grid
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="NestedGrid.js" className="my-16" iframe={false} component={NestedGridComponent} raw={NestedGridRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Inheriting columns
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="NestedGridColumns.js" className="my-16" iframe={false} component={NestedGridColumnsComponent} raw={NestedGridColumnsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Columns
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ColumnsGrid.js" className="my-16" iframe={false} component={ColumnsGridComponent} raw={ColumnsGridRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Offset
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="OffsetGrid.js" className="my-16" iframe={false} component={OffsetGridComponent} raw={OffsetGridRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Custom breakpoints
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="OverflowGrid.js" className="my-16" iframe={false} component={OverflowGridComponent} raw={OverflowGridRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CenteredElementGrid.js" className="my-16" iframe={false} component={CenteredElementGridComponent} raw={CenteredElementGridRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FullBorderedGrid.js" className="my-16" iframe={false} component={FullBorderedGridComponent} raw={FullBorderedGridRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Half border
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="HalfBorderedGrid.js" className="my-16" iframe={false} component={HalfBorderedGridComponent} raw={HalfBorderedGridRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Limitations
			</Typography>
