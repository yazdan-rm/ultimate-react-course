...
import BasicGridRaw from '../components/grid/BasicGrid.jsx?raw';
import FullWidthGridComponent from '../components/grid/FullWidthGrid';
import FullWidthGridRaw from '../components/grid/FullWidthGrid.jsx?raw';
import SpacingGridComponent from '../components/grid/SpacingGrid';
import SpacingGridRaw from '../components/grid/SpacingGrid.jsx?raw';
import RowAndColumnSpacingComponent from '../components/grid/RowAndColumnSpacing';
import RowAndColumnSpacingRaw from '../components/grid/RowAndColumnSpacing.jsx?raw';
import ResponsiveGridComponent from '../components/grid/ResponsiveGrid';
import ResponsiveGridRaw from '../components/grid/ResponsiveGrid.jsx?raw';
import InteractiveGridComponent from '../components/grid/InteractiveGrid';
import InteractiveGridRaw from '../components/grid/InteractiveGrid.jsx?raw';
import AutoGridComponent from '../components/grid/AutoGrid';
import AutoGridRaw from '../components/grid/AutoGrid.jsx?raw';
import VariableWidthGridComponent from '../components/grid/VariableWidthGrid';
import VariableWidthGridRaw from '../components/grid/VariableWidthGrid.jsx?raw';
import ComplexGridComponent from '../components/grid/ComplexGrid';
import ComplexGridRaw from '../components/grid/ComplexGrid.jsx?raw';
import NestedGridComponent from '../components/grid/NestedGrid';
import NestedGridRaw from '../components/grid/NestedGrid.jsx?raw';
import ColumnsGridComponent from '../components/grid/ColumnsGrid';
import ColumnsGridRaw from '../components/grid/ColumnsGrid.jsx?raw';
import AutoGridNoWrapComponent from '../components/grid/AutoGridNoWrap';
import AutoGridNoWrapRaw from '../components/grid/AutoGridNoWrap.jsx?raw';
import CSSGridComponent from '../components/grid/CSSGrid';
import CSSGridRaw from '../components/grid/CSSGrid.jsx?raw';
function GridDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/grid" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="InteractiveGrid.js" className="my-16" iframe={false} component={InteractiveGridComponent} raw={InteractiveGridRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Auto-layout
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ComplexGrid.js" className="my-16" iframe={false} component={ComplexGridComponent} raw={ComplexGridRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Nested Grid
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="AutoGridNoWrap.js" className="my-16" iframe={false} component={AutoGridNoWrapComponent} raw={AutoGridNoWrapRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CSSGrid.js" className="my-16" iframe={false} component={CSSGridComponent} raw={CSSGridRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				System props
			</Typography>
