...
import BasicModalRaw from '../components/modal/BasicModal.jsx?raw';
import NestedModalComponent from '../components/modal/NestedModal';
import NestedModalRaw from '../components/modal/NestedModal.jsx?raw';
import TransitionsModalComponent from '../components/modal/TransitionsModal';
import TransitionsModalRaw from '../components/modal/TransitionsModal.jsx?raw';
import SpringModalComponent from '../components/modal/SpringModal';
import SpringModalRaw from '../components/modal/SpringModal.jsx?raw';
import KeepMountedModalComponent from '../components/modal/KeepMountedModal';
import KeepMountedModalRaw from '../components/modal/KeepMountedModal.jsx?raw';
import ServerModalComponent from '../components/modal/ServerModal';
import ServerModalRaw from '../components/modal/ServerModal.jsx?raw';
function ModalDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/modal" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BasicModal.js" className="my-16" iframe={false} component={BasicModalComponent} raw={BasicModalRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="NestedModal.js" className="my-16" iframe={false} component={NestedModalComponent} raw={NestedModalRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Transitions
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TransitionsModal.js" className="my-16" iframe={false} component={TransitionsModalComponent} raw={TransitionsModalRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				Alternatively, you can use <a href="https://github.com/pmndrs/react-spring">react-spring</a>.
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SpringModal.js" className="my-16" iframe={false} component={SpringModalComponent} raw={SpringModalRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Performance
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="KeepMountedModal.js" className="my-16" iframe={false} component={KeepMountedModalComponent} raw={KeepMountedModalRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ServerModal.js" className="my-16" iframe={false} component={ServerModalComponent} raw={ServerModalRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Limitations
			</Typography>
