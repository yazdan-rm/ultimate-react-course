...
import TypesRaw from '../components/typography/Types.jsx?raw';
import TypographyThemeComponent from '../components/typography/TypographyTheme';
import TypographyThemeRaw from '../components/typography/TypographyTheme.jsx?raw';
function TypographyDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/typography" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Types.js" className="my-16" iframe={false} component={TypesComponent} raw={TypesRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Theme keys
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TypographyTheme.js" className="my-16" iframe={false} component={TypographyThemeComponent} raw={TypographyThemeRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
