...
import BoxBasicRaw from '../components/box/BoxBasic.jsx?raw';
import BoxSystemPropsComponent from '../components/box/BoxSystemProps';
import BoxSystemPropsRaw from '../components/box/BoxSystemProps.jsx?raw';
import BoxSxComponent from '../components/box/BoxSx';
import BoxSxRaw from '../components/box/BoxSx.jsx?raw';
function BoxDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/box" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BoxBasic.js" className="my-16" iframe={false} component={BoxBasicComponent} raw={BoxBasicRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BoxSystemProps.js" className="my-16" iframe={false} component={BoxSystemPropsComponent} raw={BoxSystemPropsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				With the sx prop
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BoxSx.js" className="my-16" iframe={false} component={BoxSxComponent} raw={BoxSxRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Anatomy
			</Typography>
