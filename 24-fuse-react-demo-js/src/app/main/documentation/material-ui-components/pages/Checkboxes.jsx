...
import CheckboxesRaw from '../components/checkboxes/Checkboxes.jsx?raw';
import CheckboxLabelsComponent from '../components/checkboxes/CheckboxLabels';
import CheckboxLabelsRaw from '../components/checkboxes/CheckboxLabels.jsx?raw';
import SizeCheckboxesComponent from '../components/checkboxes/SizeCheckboxes';
import SizeCheckboxesRaw from '../components/checkboxes/SizeCheckboxes.jsx?raw';
import ColorCheckboxesComponent from '../components/checkboxes/ColorCheckboxes';
import ColorCheckboxesRaw from '../components/checkboxes/ColorCheckboxes.jsx?raw';
import IconCheckboxesComponent from '../components/checkboxes/IconCheckboxes';
import IconCheckboxesRaw from '../components/checkboxes/IconCheckboxes.jsx?raw';
import ControlledCheckboxComponent from '../components/checkboxes/ControlledCheckbox';
import ControlledCheckboxRaw from '../components/checkboxes/ControlledCheckbox.jsx?raw';
import IndeterminateCheckboxComponent from '../components/checkboxes/IndeterminateCheckbox';
import IndeterminateCheckboxRaw from '../components/checkboxes/IndeterminateCheckbox.jsx?raw';
import CheckboxesGroupComponent from '../components/checkboxes/CheckboxesGroup';
import CheckboxesGroupRaw from '../components/checkboxes/CheckboxesGroup.jsx?raw';
import FormControlLabelPositionComponent from '../components/checkboxes/FormControlLabelPosition';
import FormControlLabelPositionRaw from '../components/checkboxes/FormControlLabelPosition.jsx?raw';
import CustomizedCheckboxComponent from '../components/checkboxes/CustomizedCheckbox';
import CustomizedCheckboxRaw from '../components/checkboxes/CustomizedCheckbox.jsx?raw';
function CheckboxesDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/checkboxes" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="Checkboxes.js" className="my-16" iframe={false} component={CheckboxesComponent} raw={CheckboxesRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Label
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CheckboxLabels.js" className="my-16" iframe={false} component={CheckboxLabelsComponent} raw={CheckboxLabelsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Size
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SizeCheckboxes.js" className="my-16" iframe={false} component={SizeCheckboxesComponent} raw={SizeCheckboxesRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Color
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ColorCheckboxes.js" className="my-16" iframe={false} component={ColorCheckboxesComponent} raw={ColorCheckboxesRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Icon
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="IconCheckboxes.js" className="my-16" iframe={false} component={IconCheckboxesComponent} raw={IconCheckboxesRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Controlled
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ControlledCheckbox.js" className="my-16" iframe={false} component={ControlledCheckboxComponent} raw={ControlledCheckboxRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Indeterminate
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="IndeterminateCheckbox.js" className="my-16" iframe={false} component={IndeterminateCheckboxComponent} raw={IndeterminateCheckboxRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CheckboxesGroup.js" className="my-16" iframe={false} component={CheckboxesGroupComponent} raw={CheckboxesGroupRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Label placement
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="FormControlLabelPosition.js" className="my-16" iframe={false} component={FormControlLabelPositionComponent} raw={FormControlLabelPositionRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Customization
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedCheckbox.js" className="my-16" iframe={false} component={CustomizedCheckboxComponent} raw={CustomizedCheckboxRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
