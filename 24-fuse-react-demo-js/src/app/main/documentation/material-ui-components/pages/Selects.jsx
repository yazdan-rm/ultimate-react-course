...
import BasicSelectRaw from '../components/selects/BasicSelect.jsx?raw';
import SelectVariantsComponent from '../components/selects/SelectVariants';
import SelectVariantsRaw from '../components/selects/SelectVariants.jsx?raw';
import SelectLabelsComponent from '../components/selects/SelectLabels';
import SelectLabelsRaw from '../components/selects/SelectLabels.jsx?raw';
import SelectAutoWidthComponent from '../components/selects/SelectAutoWidth';
import SelectAutoWidthRaw from '../components/selects/SelectAutoWidth.jsx?raw';
import SelectSmallComponent from '../components/selects/SelectSmall';
import SelectSmallRaw from '../components/selects/SelectSmall.jsx?raw';
import SelectOtherPropsComponent from '../components/selects/SelectOtherProps';
import SelectOtherPropsRaw from '../components/selects/SelectOtherProps.jsx?raw';
import NativeSelectDemoComponent from '../components/selects/NativeSelectDemo';
import NativeSelectDemoRaw from '../components/selects/NativeSelectDemo.jsx?raw';
import CustomizedSelectsComponent from '../components/selects/CustomizedSelects';
import CustomizedSelectsRaw from '../components/selects/CustomizedSelects.jsx?raw';
import MultipleSelectComponent from '../components/selects/MultipleSelect';
import MultipleSelectRaw from '../components/selects/MultipleSelect.jsx?raw';
import MultipleSelectCheckmarksComponent from '../components/selects/MultipleSelectCheckmarks';
import MultipleSelectCheckmarksRaw from '../components/selects/MultipleSelectCheckmarks.jsx?raw';
import MultipleSelectChipComponent from '../components/selects/MultipleSelectChip';
import MultipleSelectChipRaw from '../components/selects/MultipleSelectChip.jsx?raw';
import MultipleSelectPlaceholderComponent from '../components/selects/MultipleSelectPlaceholder';
import MultipleSelectPlaceholderRaw from '../components/selects/MultipleSelectPlaceholder.jsx?raw';
import MultipleSelectNativeComponent from '../components/selects/MultipleSelectNative';
import MultipleSelectNativeRaw from '../components/selects/MultipleSelectNative.jsx?raw';
import ControlledOpenSelectComponent from '../components/selects/ControlledOpenSelect';
import ControlledOpenSelectRaw from '../components/selects/ControlledOpenSelect.jsx?raw';
import DialogSelectComponent from '../components/selects/DialogSelect';
import DialogSelectRaw from '../components/selects/DialogSelect.jsx?raw';
import GroupedSelectComponent from '../components/selects/GroupedSelect';
import GroupedSelectRaw from '../components/selects/GroupedSelect.jsx?raw';
function SelectsDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/selects" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BasicSelect.js" className="my-16" iframe={false} component={BasicSelectComponent} raw={BasicSelectRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Advanced features
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SelectVariants.js" className="my-16" iframe={false} component={SelectVariantsComponent} raw={SelectVariantsRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Labels and helper text
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SelectLabels.js" className="my-16" iframe={false} component={SelectLabelsComponent} raw={SelectLabelsRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SelectAutoWidth.js" className="my-16" iframe={false} component={SelectAutoWidthComponent} raw={SelectAutoWidthRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Small Size
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SelectSmall.js" className="my-16" iframe={false} component={SelectSmallComponent} raw={SelectSmallRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Other props
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SelectOtherProps.js" className="my-16" iframe={false} component={SelectOtherPropsComponent} raw={SelectOtherPropsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Native select
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="NativeSelectDemo.js" className="my-16" iframe={false} component={NativeSelectDemoComponent} raw={NativeSelectDemoRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				TextField
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedSelects.js" className="my-16" iframe={false} component={CustomizedSelectsComponent} raw={CustomizedSelectsRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="MultipleSelect.js" className="my-16" iframe={false} component={MultipleSelectComponent} raw={MultipleSelectRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Checkmarks
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="MultipleSelectCheckmarks.js" className="my-16" iframe={false} component={MultipleSelectCheckmarksComponent} raw={MultipleSelectCheckmarksRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Chip
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="MultipleSelectChip.js" className="my-16" iframe={false} component={MultipleSelectChipComponent} raw={MultipleSelectChipRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Placeholder
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="MultipleSelectPlaceholder.js" className="my-16" iframe={false} component={MultipleSelectPlaceholderComponent} raw={MultipleSelectPlaceholderRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Native
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="MultipleSelectNative.js" className="my-16" iframe={false} component={MultipleSelectNativeComponent} raw={MultipleSelectNativeRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ControlledOpenSelect.js" className="my-16" iframe={false} component={ControlledOpenSelectComponent} raw={ControlledOpenSelectRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				With a dialog
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DialogSelect.js" className="my-16" iframe={false} component={DialogSelectComponent} raw={DialogSelectRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Grouping
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="GroupedSelect.js" className="my-16" iframe={false} component={GroupedSelectComponent} raw={GroupedSelectRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
