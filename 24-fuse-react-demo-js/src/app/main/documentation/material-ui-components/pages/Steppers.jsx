...
import HorizontalLinearStepperRaw from '../components/steppers/HorizontalLinearStepper.jsx?raw';
import HorizontalNonLinearStepperComponent from '../components/steppers/HorizontalNonLinearStepper';
import HorizontalNonLinearStepperRaw from '../components/steppers/HorizontalNonLinearStepper.jsx?raw';
import HorizontalLinearAlternativeLabelStepperComponent from '../components/steppers/HorizontalLinearAlternativeLabelStepper';
import HorizontalLinearAlternativeLabelStepperRaw from '../components/steppers/HorizontalLinearAlternativeLabelStepper.jsx?raw';
import HorizontalStepperWithErrorComponent from '../components/steppers/HorizontalStepperWithError';
import HorizontalStepperWithErrorRaw from '../components/steppers/HorizontalStepperWithError.jsx?raw';
import CustomizedSteppersComponent from '../components/steppers/CustomizedSteppers';
import CustomizedSteppersRaw from '../components/steppers/CustomizedSteppers.jsx?raw';
import VerticalLinearStepperComponent from '../components/steppers/VerticalLinearStepper';
import VerticalLinearStepperRaw from '../components/steppers/VerticalLinearStepper.jsx?raw';
import TextMobileStepperComponent from '../components/steppers/TextMobileStepper';
import TextMobileStepperRaw from '../components/steppers/TextMobileStepper.jsx?raw';
import SwipeableTextMobileStepperComponent from '../components/steppers/SwipeableTextMobileStepper';
import SwipeableTextMobileStepperRaw from '../components/steppers/SwipeableTextMobileStepper.jsx?raw';
import DotsMobileStepperComponent from '../components/steppers/DotsMobileStepper';
import DotsMobileStepperRaw from '../components/steppers/DotsMobileStepper.jsx?raw';
import ProgressMobileStepperComponent from '../components/steppers/ProgressMobileStepper';
import ProgressMobileStepperRaw from '../components/steppers/ProgressMobileStepper.jsx?raw';
function SteppersDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/steppers" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="HorizontalLinearStepper.js" className="my-16" iframe={false} component={HorizontalLinearStepperComponent} raw={HorizontalLinearStepperRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Non-linear
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="HorizontalNonLinearStepper.js" className="my-16" iframe={false} component={HorizontalNonLinearStepperComponent} raw={HorizontalNonLinearStepperRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Alternative label
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="HorizontalLinearAlternativeLabelStepper.js" className="my-16" iframe={false} component={HorizontalLinearAlternativeLabelStepperComponent} raw={HorizontalLinearAlternativeLabelStepperRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Error step
			</Typography>
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="HorizontalStepperWithError.js" className="my-16" iframe={false} component={HorizontalStepperWithErrorComponent} raw={HorizontalStepperWithErrorRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedSteppers.js" className="my-16" iframe={false} component={CustomizedSteppersComponent} raw={CustomizedSteppersRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Vertical stepper
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="VerticalLinearStepper.js" className="my-16" iframe={false} component={VerticalLinearStepperComponent} raw={VerticalLinearStepperRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Performance
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TextMobileStepper.js" className="my-16" iframe={false} component={TextMobileStepperComponent} raw={TextMobileStepperRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SwipeableTextMobileStepper.js" className="my-16" iframe={false} component={SwipeableTextMobileStepperComponent} raw={SwipeableTextMobileStepperRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Dots
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DotsMobileStepper.js" className="my-16" iframe={false} component={DotsMobileStepperComponent} raw={DotsMobileStepperRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Progress
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ProgressMobileStepper.js" className="my-16" iframe={false} component={ProgressMobileStepperComponent} raw={ProgressMobileStepperRaw}/>
			</Typography>
		</>);
}
