...
import BasicPopoverRaw from '../components/popover/BasicPopover.jsx?raw';
import MouseOverPopoverComponent from '../components/popover/MouseOverPopover';
import MouseOverPopoverRaw from '../components/popover/MouseOverPopover.jsx?raw';
import VirtualElementPopoverComponent from '../components/popover/VirtualElementPopover';
import VirtualElementPopoverRaw from '../components/popover/VirtualElementPopover.jsx?raw';
import PopoverPopupStateComponent from '../components/popover/PopoverPopupState';
import PopoverPopupStateRaw from '../components/popover/PopoverPopupState.jsx?raw';
function PopoverDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/popover" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="BasicPopover.js" className="my-16" iframe={false} component={BasicPopoverComponent} raw={BasicPopoverRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Anchor playground
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="MouseOverPopover.js" className="my-16" iframe={false} component={MouseOverPopoverComponent} raw={MouseOverPopoverRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Virtual element
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="VirtualElementPopover.js" className="my-16" iframe={false} component={VirtualElementPopoverComponent} raw={VirtualElementPopoverRaw}/>
			</Typography>
			<Typography className="text-14 mb-32" component="div">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="PopoverPopupState.js" className="my-16" iframe={false} component={PopoverPopupStateComponent} raw={PopoverPopupStateRaw}/>
			</Typography>
		</>);
}
