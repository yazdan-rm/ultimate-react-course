...
import AccordionUsageRaw from '../components/accordion/AccordionUsage.jsx?raw';
import AccordionExpandIconComponent from '../components/accordion/AccordionExpandIcon';
import AccordionExpandIconRaw from '../components/accordion/AccordionExpandIcon.jsx?raw';
import AccordionExpandDefaultComponent from '../components/accordion/AccordionExpandDefault';
import AccordionExpandDefaultRaw from '../components/accordion/AccordionExpandDefault.jsx?raw';
import AccordionTransitionComponent from '../components/accordion/AccordionTransition';
import AccordionTransitionRaw from '../components/accordion/AccordionTransition.jsx?raw';
import DisabledAccordionComponent from '../components/accordion/DisabledAccordion';
import DisabledAccordionRaw from '../components/accordion/DisabledAccordion.jsx?raw';
import ControlledAccordionsComponent from '../components/accordion/ControlledAccordions';
import ControlledAccordionsRaw from '../components/accordion/ControlledAccordions.jsx?raw';
import CustomizedAccordionsComponent from '../components/accordion/CustomizedAccordions';
import CustomizedAccordionsRaw from '../components/accordion/CustomizedAccordions.jsx?raw';
function AccordionDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/accordion" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="AccordionUsage.js" className="my-16" iframe={false} component={AccordionUsageComponent} raw={AccordionUsageRaw}/>
			</Typography>
...
`}
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="AccordionExpandIcon.js" className="my-16" iframe={false} component={AccordionExpandIconComponent} raw={AccordionExpandIconRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Expanded by default
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="AccordionExpandDefault.js" className="my-16" iframe={false} component={AccordionExpandDefaultComponent} raw={AccordionExpandDefaultRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Transition
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="AccordionTransition.js" className="my-16" iframe={false} component={AccordionTransitionComponent} raw={AccordionTransitionRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
				Disabled item
			</Typography>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="DisabledAccordion.js" className="my-16" iframe={false} component={DisabledAccordionComponent} raw={DisabledAccordionRaw}/>
			</Typography>
			<Typography className="text-16 mt-20 mb-10 font-700" component="h3">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="ControlledAccordions.js" className="my-16" iframe={false} component={ControlledAccordionsComponent} raw={ControlledAccordionsRaw}/>
			</Typography>
			<div className="border-1 p-16 rounded-16 my-12">
				<ul className="space-y-16">
					<li>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="CustomizedAccordions.js" className="my-16" iframe={false} component={CustomizedAccordionsComponent} raw={CustomizedAccordionsRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Performance
			</Typography>
