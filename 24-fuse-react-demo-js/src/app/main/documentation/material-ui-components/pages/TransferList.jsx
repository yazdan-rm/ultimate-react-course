...
import TransferListRaw from '../components/transfer-list/TransferList.jsx?raw';
import SelectAllTransferListComponent from '../components/transfer-list/SelectAllTransferList';
import SelectAllTransferListRaw from '../components/transfer-list/SelectAllTransferList.jsx?raw';
function TransferListDoc(props) {
    return (<>
			<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
				<DocumentationPageBreadcrumb />
				<Button className="normal-case" variant="contained" color="secondary" component="a" href="https://mui.com/components/transfer-list" target="_blank" role="button" size="small" startIcon={<FuseSvgIcon size={20}>heroicons-outline:external-link</FuseSvgIcon>}>
					Reference
				</Button>
			</div>
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="TransferList.js" className="my-16" iframe={false} component={TransferListComponent} raw={TransferListRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
			...
			<Typography className="text-14 mb-32" component="div">
				<FuseExample name="SelectAllTransferList.js" className="my-16" iframe={false} component={SelectAllTransferListComponent} raw={SelectAllTransferListRaw}/>
			</Typography>
			<Typography className="text-24 mt-24 mb-10 font-700" component="h2">
				Limitations
			</Typography>
