...
import AreaRaw from './examples/Area.jsx?raw';
import BarComponent from './examples/Bar';
import BarRaw from './examples/Bar.jsx?raw';
import ColumnComponent from './examples/Column';
import ColumnRaw from './examples/Column.jsx?raw';
import DonutComponent from './examples/Donut';
import DonutRaw from './examples/Donut.jsx?raw';
import LineComponent from './examples/Line';
import LineRaw from './examples/Line.jsx?raw';
import RadialBarComponent from './examples/RadialBar';
import RadialBarRaw from './examples/RadialBar.jsx?raw';
