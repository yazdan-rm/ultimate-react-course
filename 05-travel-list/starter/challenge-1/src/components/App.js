...
function TipCalculator() {
  ...
  return (
      <div>
        ...
        <SelectPercentage percentage={percentage1} onSelect={setPercentage1}>How did you like the
          service?</SelectPercentage>
        <SelectPercentage percentage={percentage2} onSelect={setPercentage2}>How did your friend like the
          service?</SelectPercentage>
        {bill > 0 && <>
...
function BillInput({bill, onBill}) {
  return (
      <div>
        ...
        <input type="text" placeholder={'Bill value'} value={bill} onChange={e => onBill(+e.target.value)}/>
      </div>
  );
}
